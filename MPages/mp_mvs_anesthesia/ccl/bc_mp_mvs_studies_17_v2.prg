...
/****************************************************************************************************************
  ...
  Mod  Date            Engineer                Description
   ---  --------------- ----------------------- ------------------------------------------------
    ...
    2	06/08/2012		Karen Speask			WO# 815652 - change card to cardology documents & order by event_end_dt_tm
...
plan ves
	where ves.event_set_name_key = "CARDIOLOGYDOCUMENTS"
join vesc
...
join vesx
  where vesx.event_set_cd = ves2.event_set_cd
	and not expand(e_int, 1, size(view_codes->qual, 5 ), (vesx.event_cd+0 ), view_codes->qual[e_int]->event_cd) 
...
select into 'nl:'
	group_name = cnvtupper(substring(1,50,view_codes->qual[d1.seq].top_event_set_name))
