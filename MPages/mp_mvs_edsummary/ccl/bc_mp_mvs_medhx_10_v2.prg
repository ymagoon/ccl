...
/**************************************************************************************************
  Mod  Date            Engineer                Description
   ---  --------------- ----------------------- ------------------------------------------------
    ...
    2   03/22/2012      Karen Speaks        	WO# 787368 
    											Fix for Hematologic and Immunoligic sections
...
DECLARE HEMATOLOGICMEDICALHISTORYGRID_72_CV = F8 
	with constant(uar_get_code_by("DISPLAYKEY",72,"HEMATOLOGICMEDICALHISTORYGRID")),protect
DECLARE IMMUNOLOGICMEDICALHISTORYGRID_72_CV = F8 
	with constant(uar_get_code_by("DISPLAYKEY",72,"IMMUNOLOGICMEDICALHISTORYGRID")),protect
...
plan ce1
	...
	and ce1.event_cd in (
						HEMATOLOGICMEDICALHISTORYGRID_72_CV,	
						IMMUNOLOGICMEDICALHISTORYGRID_72_CV,
						PSYCHOSOCIALMEDICALHISTORYGRID_72_CV,
