...
//      "<th style='width:143px;'>Physician<br />Relationship</th>"+
      ...
      "<th style='width:125px;'>Insurance</th>"+
      "<th style='width:55px;'>PP Ind</th>"+
      "<th style='width:55px;'>Portal</th>"+
      "<th style='width:55px;'>Readm Risk</th>"+
      "</tr>";
...
//						}
						...
						var rl_color = "-"
						var rl_text = patient.READMISSION_TEXT				
						var rl_sort = "zero none"
						var rl_risk = patient.READMISSION_RISK								
						if (rl_text == "High")
								{	
								rl_color =  "<img src='../images/red_bullet.gif' width = '10' height='10'  />"
								rl_sort = "Risk zHigh"
							};
						if (rl_text == "Moderate")
								{	
								rl_color =  "<img src='../images/orange_bullet.gif' width = '10' height='10'  />"
								rl_sort = "Risk xMod"
							};					
						if (rl_text == "Low")
								{	
								rl_color =  "<img src='../images/green-bullet.gif' width = '10' height='10'  />"
								rl_sort = "Risk xLow"
							};	
...
//									"<td>" + patient.RELATIONSHIP_VC + "</td>" +
									...
									"<td align = 'center'><span><span style='display:none;'>" + rl_sort + "</span>" + rl_text + "</span></td>"	
