...
// General Messages
i18n.MORE_THAN_2_DAYS               = "More Than 2 Days" 
i18n.TWO_DAYS                       = "2 Days"
i18n.TOMORROW                       = "Tomorrow"
i18n.UPCOMING						= "Upcoming"
i18n.OPEN_ITEMS						= "Open Items"
i18n.MY_DAY							= "Day View"
...
i18n.NOTES_IND						= "Note Reminders"
i18n.ORDERS_IND						= "Charge Reminders"
i18n.TASK_IND						= "Task Reminders"
i18n.SUMMARY_IND                    = "Visit Summary Reminders"	
i18n.HP_IND							= "H and P Reminders"
i18n.CONSENT_IND					= "Consent Reminders"
i18n.PREOP_IND                    	= "Pre-Op Orders Reminders"
i18n.UNDO_IND                       = "Undo Last Checked Task"
i18n.UNDO_ALERT                     = "The undo function is not available. Your screen will be refreshed."
i18n.UNDO_STATUS                    = "Undo Status"
i18n.TOTAL_TIME_IN_OFFICE 			= "Total Time in Office"
...
i18n.NOTE_COMPLETED					= "Note Completed"
i18n.NOTE_COMPLETED_BY_RESIDENT     = "Resident Signed Note"
i18n.NOTE_COMPLETED_BY_RESIDENT_MANUALLY     = "Resident Dictated Note"
i18n.NOTE_SAVED_BY_RESIDENT         = "Resident Saved Note"
i18n.ORDER_NOT_STARTED				= "Charge Not Started"
i18n.ORDER							= "Order"
i18n.POWERPLAN						= "PowerPlan"
i18n.ORDER_COMPLETED				= "Charge Completed"
i18n.TASK_LIST_COMPLETE             = "Task List Complete"	
i18n.TASK_LIST_NOT_COMPLETE	        = "Task List Not Complete"
i18n.VISIT_SUMM_NOT_STARTED 		= "Visit Summary Not Started"
i18n.VISIT_SUMM_COMPLETE			= "Visit Summary Complete"
i18n.VISIT_SUMM_START				= "Start Visit Summary"
i18n.VISIT_SUMM_DECLINE				= "Decline Visit Summary"
i18n.VISIT_SUMM_DECLINE_COMPLETE	= "Visit Summary Declined"
i18n.HP_NOT_STARTED					= "H and P Not Started"
i18n.CONSENT_NOT_STARTED			= "Consent Not Started"
i18n.PREOP_ORDER_NOT_STARTED		= "Pre-Op Orders Not Started"
i18n.HP_COMPLETED					= "H and P Complete"
i18n.CONSENT_COMPLETED				= "Consent Complete"
i18n.PREOP_ORDER_COMPLETE			= "Pre-Op Orders Completed"
i18n.HP_SAVED						= "H and P Saved"
i18n.CONSENT_SAVED					= "Consent Saved"
i18n.ORDER_ID						= "Order ID"
i18n.ORDER_STATUS                   = "Order Status"
i18n.POWERPLAN_ID					= "PowerPlan ID"
i18n.POWERPLAN_STATUS               = "PowerPlan Status"
...
i18n.WITHIN_HOUR 					="{0} hr";
i18n.WITHIN_MINS					="{0} mins";
i18n.WITHIN_MIN 					="{0} min";
...
i18n.ADD_NEW_COMMENT				= "Add New Comment"
i18n.COMMENT_DELETE_MESSAGE			="Are you sure you want to delete this comment?";
i18n.COMMENT_DELETE_TITLE			="Delete Comment?";
i18n.COMMENT_ERROR					="Error occured while saving comment";
i18n.COMMENT_CHAR_MAX				="*Comments have a 255 character maximum";
i18n.COMMENTS						="Comments";
i18n.SELECTION_LIMIT_ALERT          ="The maximum number of resources that can be selected is";

//appointment type location 
i18n.CLINIC							= "Clinic";
i18n.SURGERY						= "Surgery";

//surgery info //mt4217
i18n.SURGEON						= "Surgeon";
i18n.ANESTHESIA_TYPE				= "Anaesthesia Type";
i18n.ANESTHESIOLOGIST				= "Anaesthesiologist";
i18n.PROCEDURE						= "Procedure";
i18n.PRE_OP							= "Pre-Op";
i18n.INTRA_OP						= "Intra-Op";
i18n.POST_OP						= "Post-Op";
i18n.CHECKED_OUT 					= "Checked Out";        
i18n.CHECKED_IN 					= "Checked In";
i18n.CONFIRMED 						= "Confirmed";
i18n.CANCELED 						= "Canceled" ;
i18n.NO_SHOW 						= "No Show" ;
i18n.HOLD	 						= "Hold" ;
...
// General Messages
i18n.PTS_NOT_FOUND 		= "There are no patients in the selected list.";	
i18n.LOADING_DIALOG 		= "Loading Patient Data...";
i18n.LOADING_GROUPS 		= "Loading Patients...";
i18n.OF					= "of";
i18n.DEFAULT_TAB			= "";
i18n.DISCLAIMER			= "This page is not a complete source of visit information."
i18n.PTLISTS_NOT_FOUND 	= "A patient list could not be found.  Please go to patient list maintenance to define a patient list and try again.";
i18n.PATIENT_LIST		= "Patient List:"
i18n.SELECT_ONE_OR_MORE_NURSE_UNITS = "Please select one or more nurse units.";
i18n.ERROR_LOADING_WORKLIST = "An error has occurred when loading Worklist.";
i18n.LOADING_WORKLIST = "Loading Worklist...";
i18n.LOADING_NURSE_UNITS = "Loading Nurse Units...";
i18n.SUBMIT_BUTTON = "Submit"
i18n.FACILITIES_LABEL = "Facilities:";
i18n.SELECT_FACILITIY = "Select Facility.";
i18n.SELECT_OTHER_SOURCE = "Select";
i18n.NURSE_UNITS = "Nurse Units";
i18n.FN_TRACK_GROUP = "Track Group";
i18n.CLICK_OPEN_NURSE_UNITS = "Click to open Nurse Units.";
i18n.PATIENT_LISTS_NOT_FOUND ="A patient list could not be found. Please go to patient list maintenance to define a patient list and try again.";
i18n.OR = "Or";
i18n.INSMESSAGE_PL_FN = "In order to display list of qualifying patients, select either a Patient List or a Facility and Nurse unit from the selections above and click the Submit button.";
i18n.INSMESSAGE_PL = "In order to display list of qualifying patients, select a Patient List from the selections above.";
i18n.INSMESSAGE_FN = "In order to display list of qualifying patients, select a Facility and Nurse unit from the selections above and click the Submit button.";
i18n.DEFAULT_PTLIST = "Select a Patient List";
i18n.DEFAULT_FACILITY = "Select a Facility";
i18n.VALID_FACILITY_ERROR = "Please select a valid facility.";
i18n.VALID_PTLIST_ERROR = "Please select a valid patient list.";
