...
i18n.COMMENT_ERROR					="Error occurred while saving comment";
...
i18n.ANESTHESIA_TYPE				= "Anaesthetic Type";
...
i18n.xgcalendar = {
        ...
        confrim_delete_event_or_all: "Do you wish to delete all repeat events or only this event? \r\nClick [OK] to delete only this event, click [Cancel] delete all events",
        ...
        SEENBYPHYSIC : "Seen By Clinician",
...
i18n.SELECT_ONE_OR_MORE_NURSE_UNITS = "Please select one or more nurse wards.";
i18n.ERROR_LOADING_WORKLIST = "An error has occurred when loading Worklist.";
i18n.LOADING_WORKLIST = "Loading Worklist...";
i18n.LOADING_NURSE_UNITS = "Loading Nurse Wards...";
...
i18n.NURSE_UNITS = "Nurse Wards";
i18n.FN_TRACK_GROUP = "Track Group";
i18n.CLICK_OPEN_NURSE_UNITS = "Click to open Nurse Wards.";
...
i18n.OR = "Or";
i18n.INSMESSAGE_PL_FN = "In order to display list of qualifying patients, select either a Patient List or a Facility and Nurse ward from the selections above and click the Submit button.";
i18n.INSMESSAGE_PL = "In order to display list of qualifying patients, select a Patient List from the selections above.";
i18n.INSMESSAGE_FN = "In order to display list of qualifying patients, select a Facility and Nurse ward from the selections above and click the Submit button.";
