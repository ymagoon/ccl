...
function WizardComponent(criterion)
{
    ...
    this.setComponentLoadTimerName("USR:MPG.CLINIC_CHARGE_WIZARD.O1 - load component");
    this.setComponentRenderTimerName("ENG:MPG.CLINIC_CHARGE_WIZARD.O1 - render component");
...
var CERN_WIZARD_O1 = function ()
{
    ...
    function GetComponentsListPanel()
    {
        ...
        var componentMapping = new Array(
            new MP_Core.MapObject("mp_cc_visit_types", VisitTypesComponent),
            new MP_Core.MapObject("mp_cc_present_prob", PresentingProblemsComponent),
            new MP_Core.MapObject("mp_cc_process_mgt", ProcessManagementComponent),
            new MP_Core.MapObject("mp_cc_order_mgt", OrderManagementComponent),
            new MP_Core.MapObject("mp_cc_nurse_assess", NursingAssessmentComponent),
            new MP_Core.MapObject("mp_cc_critical_care", CriticalCareComponent),
            new MP_Core.MapObject("mp_cc_disposition", DispositionComponent),
            new MP_Core.MapObject("mp_cc_new_establish", NewEstablishedComponent),
            new MP_Core.MapObject("mp_cc_pt_education", PatEdComponent)
        );
        var pageFuncFilterMapping = new Array(
        );
        var compFuncFilterMapping = new Array(
            new MP_Core.MapObject('mp_cc_visit_types', '{"FUNCTIONS":[' +
            ...
            ']}'),
            new MP_Core.MapObject('mp_cc_present_prob', '{"FUNCTIONS":[' +
            ...
            ']}'),
            new MP_Core.MapObject('mp_cc_pt_education', '{"FUNCTIONS":[' +
            '{"FILTER_MEAN": "PT_ED_REF_EXPAND_IND", "NAME":"setReferenceTxtInd", "TYPE":"Boolean", "FIELD": "FREETEXT_DESC"},' +
            '{"FILTER_MEAN": "PT_ED_READ_ONLY_IND", "NAME":"setReadOnlyInd", "TYPE":"Boolean", "FIELD": "FREETEXT_DESC"}' +
            ']}'),
            new MP_Core.MapObject('mp_cc_new_establish', '{"FUNCTIONS":[' +
            '{"FILTER_MEAN": "NEW_ESTAB_REF_EXPAND_IND", "NAME":"setReferenceTxtInd", "TYPE":"Boolean", "FIELD": "FREETEXT_DESC"},' +
            '{"FILTER_MEAN": "NEW_ESTAB_READ_ONLY_IND", "NAME":"setReadOnlyInd", "TYPE":"Boolean", "FIELD": "FREETEXT_DESC"}' +
            ']}'),
            new MP_Core.MapObject('mp_cc_process_mgt', '{"FUNCTIONS":[' +
            ...
            ']}'),
            new MP_Core.MapObject('mp_cc_order_mgt', '{"FUNCTIONS":[' +
            ...
            ']}'),
            new MP_Core.MapObject('mp_cc_nurse_assess', '{"FUNCTIONS":[' +
            ...
            ']}'),
            new MP_Core.MapObject('mp_cc_critical_care', '{"FUNCTIONS":[' +
            ...
            ']}'),
            new MP_Core.MapObject('mp_cc_disposition', '{"FUNCTIONS":[' +
