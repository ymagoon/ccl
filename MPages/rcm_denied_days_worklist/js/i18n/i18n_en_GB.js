 ...
 * Contains all of the i18n key/value pairs used within the rcm_denied_days project.
 */
var rcm_ddw_worklist_i18n = function() {
    return {
		...
		CANCEL: "Cancel",
		CANCELED_MESSAGE: "Denial has been canceled because the corresponding Patient Accounting work item was canceled.",
		CLAIM_ID: "Claim ID:",
    	...
    	CURRENCY_MAX_DECIMAL : 2, // The number of characters allowed after decimal point.
    	CURRENCY_SYMBOL : "$",
    	CURRENCY_SYMBOL_PLACEMENT : "p",  // Use either "p" or "s" for prefix or suffix, respectively.
    	CURRENCY_THOUSAND_GROUPING : 3, // The number of digits between the thousand separator.
    	CURRENCY_MAX_NUMBER_VALUE: "999999999999.99", //12 9's before and 2 9's after, The Maximum value allowed
        CURRENCY_MIN_NUMBER_VALUE: "0.00", //Minimum value enterable, no negative numbers allowed
		DAYS_AGO: " days ago",
		DENIAL_MANAGER:"Denial Manager",
		DENIALS_WITH_APPEALS:"Denials with appeals",
		DENIALS_WITH_APPEALS_INCLUDE:"Include denials with appeals",
		DENIED_DAYS: "Denied Days",
		...
		FIN: "FIN:",
		FINAL: "Final",
		INCLUDE_PATIENTS_WITH: "Include patients with:",
		LETTER_CREATED: "Letter Created:",
		LETTER_DATE: "Letter Date",
		LETTER_RECEIVED: "Letter Received:",
		NO_APPEAL_IN_PROCESS: "No appeal in process",
		NO_DATE: "No Date",
		NO_DAYS_LISTED: "No Days Listed",
		...
		SAVE: "Save",
		SAVE_CONFIGURATION: "Save configuration as default",
		SAVE_FAILED: "Unable to Save",
		SAVE_FAILED_MESSAGE: "The system was unable to save. Try again.",
		SECONDARY_SORT: "Secondary:",
		SEVERITY_OF_ILLNESS: "SOI:",
		SORTING: "Sorting",
		STALE_DATA_MESSAGE: "The encounter selected has been updated since opening the current session.  It cannot be saved until the data has been refreshed.  Reload the Documentation Review Worklist to view the updates and continue modifications.",
		STALE_DATA_TITLE: "Unable to Save",
		TODAY: "Today",
		TOMORROW: "Tomorrow",
		TYPE: "Type",
