...
}i18n.discernabu.graph={DATE_TIME:"Date/Time",RESULT:"Result",DATE:"Date",NORMAL_LOW:"Normal Low",NORMAL_HIGH:"Normal High",CRITICAL_LOW:"Critical Low",CRITICAL_HIGH:"Critical High",TWO_DAY_MAX:"48 Hour Max",TWO_DAY_MIN:"48 Hour Min",RESULT_DT_TM:"Result Date/Time",SYS:"SYS",DIA:"DIA",GRAPH_NO_RESULTS:"There are no results to display for this graph",MISSING_STATIC_CONTENT_LOC:"Missing Static Content Location:",NO_UNITS_FOUND:"No units found",UNGRAPHABLE_WARNING:"* Result not represented on the graph",STATUS:"Status",PRINTGRAPH:"Print"};
