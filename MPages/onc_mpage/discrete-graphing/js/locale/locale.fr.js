...
}i18n.discernabu.graph={DATE_TIME:"Date/Heure",RESULT:"Résultat",DATE:"Date",NORMAL_LOW:"Normal faible",NORMAL_HIGH:"Normal élevé",CRITICAL_LOW:"Critique faible",CRITICAL_HIGH:"Critique élevé",TWO_DAY_MAX:"48 heures maximum",TWO_DAY_MIN:"48 heures minimum",RESULT_DT_TM:"Date/Heure de résultat",SYS:"SYS",DIA:"DIA",GRAPH_NO_RESULTS:"Il n'y a aucun résultat à afficher pour ce graphique.",MISSING_STATIC_CONTENT_LOC:"Emplacement du contenu statique manquant :",NO_UNITS_FOUND:"Aucune unité n'a été trouvée",UNGRAPHABLE_WARNING:"* Résultat non représenté sur le graphique",STATUS:"Statut",PRINTGRAPH:"Imprimer"};
