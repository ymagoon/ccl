function PsychosocialFactorsComponentStyle(){this.initByNamespace("psy");
}PsychosocialFactorsComponentStyle.inherits(ComponentStyle);
function PsychosocialFactorsComponent(criterion){this.setCriterion(criterion);
...
PsychosocialFactorsComponent.method("HandleSuccess",function(replyAr,component){CERN_PSY_FACTOR_O1.RenderComponent(component,replyAr[0].getResponse());
});
}PsychosocialFactorsComponent.inherits(MeasurementBaseComponent);
var CERN_PSY_FACTOR_O1=function(){return{RenderComponent:function(component,recordData){var timerRenderComponent=MP_Util.CreateTimer(component.getComponentRenderTimerName());
...
ar.push("<dl class='psy-info'><dt class='psy-disp-lbl'>",display,"</dt><dd class='psy-name'>",display,"</dd><dt class='psy-res-lbl'>",i18n.discernabu.psychosocialfactors_o1.RESULT," </dt><dd class='psy-res'>");
