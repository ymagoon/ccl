...
return;
}else{sendAr.push("^MINE^",criterion.person_id+".0",criterion.encntr_id+".0");
MP_Core.XMLCclRequestWrapper(component,"mp_get_pregnancy_history",sendAr,true);
}},RenderComponent:function(component,recordData){try{var jsPREGHTML=[];
var buildSec=[];
var pregHTML="";
var childRecord="";
var childDetl="";
...
if(childRecord.LENGTH_LABOR!=="-1"){laborLength=childRecord.LENGTH_LABOR;
