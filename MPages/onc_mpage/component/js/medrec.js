...
MedicationReconciliationComponent.method("openTab",function(){var slaTimer=MP_Util.CreateTimer("CAP:MPG Med-Rec Add");
if(slaTimer){slaTimer.SubtimerName=medrec_mpage;
slaTimer.Start();
slaTimer.Stop();
...
function getDischargeCode(){if(dischargeMedCd===0){var code=MP_Util.GetCodeValueByMeaning("DISCHARGEMED",54732);
...
},RenderComponent:function(component,recordData){try{var sHTML="",countText="",jsHTML=[];
var len=0;
...
}else{jsHTML.push("<span class='res-none'>",medReci18n.NO_RESULTS_FOUND,"</span></div></div>");
...
function getMedsRow(medData,medReci18n){var jsHTML=[];
var strHTML="";
