...
function MicrobiologyComponent(criterion){this.setLookBackDropDown(true);
...
MicrobiologyComponent.prototype.InsertData=function(){CERN_MICROBIOLOGY_O1.GetMicrobiologyTable(this);
};
MicrobiologyComponent.prototype.HandleSuccess=function(recordData){CERN_MICROBIOLOGY_O1.RenderComponent(this,recordData);
};
...
jsMicHTML.push("<div class='mic-info-hdr hdr' id = 'mic-info-hd",component.getComponentId(),"'><dl class='mic-info-hds'><dd class='mic-rep-hd'><span>",micI18n.REPORT,"</span></dd><dd class='mic-status-hd'><span>",micI18n.STATUS,"</span></dd><dd class='mic-growth-hd'><span>",micI18n.GROWTH,"</span></dd><dd class='mic-no-sc'><span>",micI18n.SUSC_HEADER,"</span></dd><dd class='mic-within-hd'><span>",micI18n.COLLECTED);
...
sParams.push(micObj[i].PERSON_ID+".0",micObj[i].ENCNTR_ID+".0",micObj[i].EVENT_ID+".0",'"'+sRepDisp+'"','"'+micObj[i].VIEWER_TYPE+'"',micObj[i].PARENT_EVENT_ID+".0",'""',0,0,'""');
...
}else{jsMicHTML.push("<h3 class='info-hd'><span>",micI18n.MICRO,"</span></h3>","<dl class='mic-info'>","<dt><span>",micI18n.MICRO,":</span></dt>","<dd class='mic-report'><span>",MP_Util.CreateClinNoteLink(micObj[i].PERSON_ID+".0",micObj[i].ENCNTR_ID+".0",micObj[i].EVENT_ID+".0",sRepDisp,micObj[i].VIEWER_TYPE,micObj[i].PARENT_EVENT_ID+".0"),"</span>");
