function PregAssessment2Style(){this.initByNamespace("pa2");
}PregAssessment2Style.inherits(ComponentStyle);
function PregAssessment2Component(criterion){this.setCriterion(criterion);
...
PregAssessment2Component.method("InsertData",function(){CERN_PREG_ASSESSMENT2_O1.GetPregAssessment2Data(this);
});
PregAssessment2Component.method("HandleSuccess",function(recordData){CERN_PREG_ASSESSMENT_BASE_O1.RenderAssessmentSection(this,recordData,2);
});
PregAssessment2Component.method("RetrieveRequiredResources",function(){var patientGenderInfo=criterion.getPatientInfo().getSex();
...
PregAssessment2Component.method("setAntepartumNote2",function(value){this.m_antepartumNote2=value;
});
PregAssessment2Component.method("getAntepartumNote2",function(){return this.m_antepartumNote2;
});
...
var CERN_PREG_ASSESSMENT2_O1=function(){function updateComponentMenu(component){var compId=component.getComponentId();
...
}catch(discernErr){MP_Util.LogJSError(discernErr,this,"pregnancyassessment2-o1.js","menuItemOnClickHandler");
return;
}});
...
}return{GetPregAssessment2Data:function(component){var sendAr=[];
var criterion=component.getCriterion();
var messageHTML="";
var pai18n=i18n.discernabu.pregassessmentbase;
var pregInfoObj=null;
...
MP_Util.Doc.FinalizeComponent(messageHTML,component,"(0)");
return;
}else{sendAr.push("^MINE^",criterion.person_id+".0",criterion.provider_id+".0",criterion.position_cd+".0",criterion.ppr_cd+".0",pregInfoObj.getLookBack(),"2");
