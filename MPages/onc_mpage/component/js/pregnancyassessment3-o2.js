function PregAssessment3StyleWF(){this.initByNamespace("pa3-wf");
}PregAssessment3StyleWF.inherits(ComponentStyle);
function PregAssessment3ComponentWF(criterion){this.setCriterion(criterion);
...
PregAssessment3ComponentWF.prototype.preProcessing=function(){var criterion=this.getCriterion();
...
PregAssessment3ComponentWF.prototype.menuItemOnClickHandler=function(clickEvent){var criterion=this.getCriterion();
var pai18n=i18n.discernabu.pregassessmentbase_o2;
...
}}}catch(discernErr){MP_Util.LogJSError(discernErr,this,"pregnancyassessment3-o2.js","menuItemOnClickHandler");
return;
}pregDiscernObject=null;
};
PregAssessment3ComponentWF.prototype.removeMenuOptions=function(){var menuComp=this.getMenu();
var compId=this.getComponentId();
...
PregAssessment3ComponentWF.prototype.RetrieveRequiredResources=function(){var pregInfoObj=null;
...
PregAssessment3ComponentWF.prototype.retrieveComponentData=function(){var sendAr=[];
...
PregAssessment3ComponentWF.prototype.renderComponent=function(recordData){var criterion=this.getCriterion();
