...
if(!recordData.VISITS[i].IS_VISIT_BASED_CARD){for(j=0,dLen=recordData.VISITS[i].FUNDAL_HEIGHT.length;
j<dLen;
...
if(!recordData.VISITS[i].IS_VISIT_BASED_CARD){for(j=0,dLen=recordData.VISITS[i].PRETERM_SIGNS.length;
j<dLen;
...
if(!recordData.VISITS[i].IS_VISIT_BASED_CARD){for(j=0,dLen=recordData.VISITS[i].CERVICAL_DIL.length;
j<dLen;
...
if(!recordData.VISITS[i].IS_VISIT_BASED_CARD){for(j=0,dLen=recordData.VISITS[i].CERVICAL_EFF.length;
j<dLen;
...
if(!recordData.VISITS[i].IS_VISIT_BASED_CARD){for(j=0,dLen=recordData.VISITS[i].CERVICAL_STAT.length;
j<dLen;
...
tempVal="";
tempVal2="";
if(!recordData.VISITS[i].IS_VISIT_BASED_CARD){for(j=0,dLen=recordData.VISITS[i].BP.length;
j<dLen;
...
tempVal="";
tempUnit="";
if(!recordData.VISITS[i].IS_VISIT_BASED_CARD){for(j=0,dLen=recordData.VISITS[i].WEIGHT.length;
j<dLen;
...
tempVal="";
if(!recordData.VISITS[i].IS_VISIT_BASED_CARD){for(j=0,dLen=recordData.VISITS[i].WEIGHT_CHG.length;
j<dLen;
...
tempVal="";
if(!recordData.VISITS[i].IS_VISIT_BASED_CARD){for(j=0,dLen=recordData.VISITS[i].EDEMA.length;
j<dLen;
...
tempVal="";
if(!recordData.VISITS[i].IS_VISIT_BASED_CARD){for(j=0,dLen=recordData.VISITS[i].URINE_PROTEIN.length;
j<dLen;
...
tempVal="";
if(!recordData.VISITS[i].IS_VISIT_BASED_CARD){for(j=0,dLen=recordData.VISITS[i].URINE_GLUCOSE.length;
j<dLen;
...
tempVal="";
if(!recordData.VISITS[i].IS_VISIT_BASED_CARD){for(j=0,dLen=recordData.VISITS[i].PAIN.length;
j<dLen;
...
tempVal="";
tempUnit="";
if(!recordData.VISITS[i].IS_VISIT_BASED_CARD){for(j=0,dLen=recordData.VISITS[i].NEXT_APPT.length;
j<dLen;
...
}if(!recordData.VISITS[i].IS_VISIT_BASED_CARD){fPresentArray.push(tempObj);
...
dynamicLabelArray.push(newObj);
}if(!recordData.VISITS[i].IS_VISIT_BASED_CARD){fMoveArray.push(tempObj);
...
allFetalDataCollection[tempObj.DYNAMIC_LABEL_ID]=newObj;
dynamicLabelArray.push(newObj);
}if(!recordData.VISITS[i].IS_VISIT_BASED_CARD){fHRArray.push(tempObj);
...
allFetalDataCollection[tempObj.DYNAMIC_LABEL_ID]=newObj;
dynamicLabelArray.push(newObj);
}if(!recordData.VISITS[i].IS_VISIT_BASED_CARD){fLieArray.push(tempObj);
