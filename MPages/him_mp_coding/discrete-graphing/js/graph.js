        ...
        $(".flot-graph").bind("plothover", function(event, pos, item){
            ...
            if (item) {
                if (previousPoint != item.datapoint) {
                    ...
                    ar.push("<div class='hvr'><dl><dt><span>", displayEvent, ":</span></dt><dd><span class='", normalcy, "'>", y, " " + graphDetails.UNITS, "</span></dd><br/><dt><span>",graphi18n.RESULT_DT_TM ,":</span></dt><dd><span>", dateTime, "</span></dd>");
