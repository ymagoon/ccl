...
}i18n.discernabu.consolproblem_o1={ADD_NEW_AS:"Agregar nuevo como:",ALL:"Todo",AND:"y",CANCEL:"Cancelar",CHANGE_TO_MEDICAL:"Cambiar a médico",CLASSIFICATION:"Clasificación",CONDITION:"Condición",CONFIRM:"Confirmar",DIAGNOSIS_DETAILS:"Detalles de diagnóstico",DUPLICATE_MSG:"Esta acción crearía un duplicado en la sección {0}.  La condición no se agregará a la sección {0}.",ENCNTR_MSG:"Debe cargarse un episodio clínico antes de realizar esta acción.",FILTER_MSG:"Hubo un problema al guardar el cambio de filtro. Inténtelo de nuevo.",INACTIVATE:"Desactivar",MEDICAL_AND_PATIENT_STATED:"Personal médico y paciente establecidos",MOVE_TO:"Mover a {0}",NO_ADD_CONDITION_MSG:"No tiene los privilegios para agregar esta condición a la sección {0}.",NO_PRIVS_MSG:"No tiene los privilegios para realizar esta acción.",PROBLEM_RETRIEVING_DATA:"Problema al recuperar los datos {0}",PROBLEM_STATUS:"Estado del problema",PROBLEM_TYPE_FLAG_2_MSG:"Este problema sólo puede modificarse a través del control de embarazo y su acción actual no lo modificará.",PROCESSING:"Procesando...",RECENT_VISITS:"Visitas recientes",REMOVE_FROM:"Quitar de {0}",RESOLVE:"Solucionar",NO_ACTION_FREETEXT:"No tiene la habilidad de realizar esta acción en un problema o diagnóstico de texto libre."};
...
}i18n.discernabu.immunization={IMMUNIZATIONS_DETAILS:"Detalles de vacunas",IMMUNIZATIONS:"Vacunas",TYPE:"Tipo",STATUS:"Estado",PRODUCT:"Producto",ADMIN_DATE:"Fecha de administraci�n",DOCUMENTED_BY:"Documentado por",DETAILS:"Detalles",MANUFACTURER:"Fabricante",LOT:"Lote",EXP_DATE:"Fecha de vencimiento",ADMIN_NOTES:"Notas de administraci�n"};
if(typeof i18n=="undefined"){var i18n={};
}if(typeof i18n.discernabu=="undefined"){i18n.discernabu={};
}i18n.discernabu.laboratory_o1={WITHIN:"en",LATEST:"Último",PREVIOUS:"Anterior",EXPAND:"Expandir",COLLAPSE:"Contraer",PRIMARY_RESULTS:"Resultados principales",SECONDARY_RESULTS:"Resultados secundarios",VALUE:"Valor",LABORATORY_DETAILS:"Detalles de laboratorio",DATE_TIME:"Fecha/hora",NORMAL_LOW:"Bajo normal",NORMAL_HIGH:"Alto normal",CRITICAL_LOW:"Bajo crítico",CRITICAL_HIGH:"Alto crítico",STATUS:"Estado"};
...
}i18n.discernabu.past_medical_history_o1={ANNOTATED_DISPLAY:"Nombre de visualización anotada",CODE:"Código",COMMENTS:"Comentarios",ONSET_DATE:"Fecha de comienzo",PAST_MEDICAL_DETAILS:"Detalles de historial médico pasado",PAST_MEDICAL_HISTORY:"Historial médico pasado",PAST_PROBLEM:"Problema",PAST_RESOLVED_DATE:"Fecha de resolución",STATUS:"Estado"};
if(typeof i18n=="undefined"){var i18n={};
}if(typeof i18n.discernabu=="undefined"){i18n.discernabu={};
}i18n.discernabu.patient_background_o1={ATTENDING_PHYSICIAN:"Médico encargado",SERVICE:"Servicio",RESUSITATION_STATUS:"Estado de reanimación",NO_RESULTS_FOUND:"No se encuentran resultados",ADVANCE_DIRECTIVE:"Avanzar directiva",ISOLATION:"Aislamiento",TARGET_DISCH_DT_TM:"Fecha/hora de alta límite",ACTIVITY_ORDER:"Indicación de actividad",PARENT_PART_TYPE:"Relación del tutor legal",GESTATIONAL_AGE:"Edad gestacional",PARA_GRAVIDA:"Partos/embarazos",FALL_RISK_SCORE:"Escala de riesgo de caídas",ASSISTIVE_DEVICES:"Tecnología asistencial",MULTIPLE:"Múltiple",DEVICE_DETAILS:"Detalles de dispositivo",SEIZURE_PRECAUTIONS:"Precauciones ante convulsiones",DIET:"Dieta",PAIN_SCORE:"Escala del dolor",DATE_TIME:"Fecha/hora",STATUS:"Estado"};
if(typeof i18n=="undefined"){var i18n={};
}if(typeof i18n.discernabu=="undefined"){i18n.discernabu={};
}i18n.discernabu.patinfo_o1={NO_RESULTS_FOUND:"No se encuentran resultados",RFV:"Razón de la visita",ROOM_BED:"Habitación/Cama",ADMIT_DIAG:"Diagnóstico de admisión",ADMIT_DATE:"Fecha de admisión",PRIM_PHYS:"Médico principal",ATTEND_PHYS:"Médico encargado",EMER_CONTACT:"Contacto de emergencia",EMER_NUMBER:"Nº de emergencia",CODE_STATUS:"Estado de código",LAST_VISIT:"Última visita",LAST:"Última",VISIT:"Visita",CONTACTS:"Contactos",ADMIT_PHYS:"Médico responsable de la admisión",TARGETED_DISCHARGE_DATE:"Fecha de alta meta",SERVICE:"Servicio",MODE_OF_ARRVAL:"Modo de llegada",ADVANCE_DIRECTIVE:"Avanzar directiva",DETAILS:"Detalles",CHIEF_COMPLAINT:"Queja principal"};
...
}i18n.discernabu.vitals_o1={BLOOD_PRESSURE:"Tensión arterial",TEMPERATURE:"Temperatura",HEART_RATE:"H",DEGC:"Grados C",DEGF:"Grados F",NORMAL_LOW:"Bajo normal",NORMAL_HIGH:"Alto normal",CRITICAL_LOW:"Bajo crítico",CRITICAL_HIGH:"Alto crítico",TWO_DAY_MAX:"Máximo 48 horas",LATEST:"Último",WITHIN:"en",PREVIOUS:"Anterior",DATE_TIME:"Fecha/hora",ERROR_RETREIVING_DATA:"Error al recuperar los resultados",VALUE:"Valor",LABORATORY_DETAILS:"Detalles de laboratorio",LOADING_DATA:"Cargando",STATUS:"Estado",TWO_DAY_MIN:"Mínimo 48 horas"};
if(typeof i18n=="undefined"){var i18n={};
}if(typeof i18n.discernabu=="undefined"){i18n.discernabu={};
}i18n.discernabu.weights_o1={LATEST:"Último",WITHIN:"en",PREVIOUS:"Anterior",CHANGE:"Cambio",ADMISSION:"Admisión",MEASUREMENT_DETAILS:"Detalles de medición",NAME:"Nombre",RESULT:"Resultado",DATE_TIME:"Fecha/hora",STATUS:"Estado"};
