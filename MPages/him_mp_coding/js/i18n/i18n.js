...
}i18n.accesshim.him.registrationDischarge={REGISTRATION_DATE:"Registration Date",ADMIT_DATE:"Admit Date",DISCHARGE_DATE:"Discharge Date",DISCHARGE_DISPOSITION:"Discharge Disposition",DISCHARGE_LOCATION:"Discharge Location",DECEASED_DATE:"Deceased Date",CAUSE_OF_DEATH:"Cause of Death",LOS:"LOS",DAYS:"days",DAY:"day",ENCOUNTER_TYPE:"Encounter Type",ATTENDING_PHYSICIAN:"Attending Physician",FACILITY:"Facility",PAYER:"Payer",SECONDARY_PAYER:"Secondary Payer",ADMIT_SOURCE:"Admit Source",READMISSION_24:"24",READMISSION_72:"72",READMISSION_HR_ADMISSION:"-hour admission",READMISSION_MSG_1:" - This encounter occurred within ",READMISSION_MSG_2:" hours of the previous encounter."};
...
var him_mp_coding_i18n = new function() {
	return {
		PAGE_TITLE : "Coding mPage"
	};
}();