...
}i18n.discernabu.consolproblem_o1={ADD_NEW_AS:"Neu hinzufügen als:",ALL:"Alle",AND:"und",CANCEL:"Abbrechen",CHANGE_TO_MEDICAL:"Zu Medizinisch ändern",CLASSIFICATION:"Klassifikation",CONDITION:"Krankheitsbild",CONFIRM:"Bestätigen",DIAGNOSIS_DETAILS:"Diagnose - Details",DUPLICATE_MSG:"Diese Aktion würde ein Duplikat im Abschnitt {0} erzeugen. Der Patientenzustand wird nicht zum Abschnitt {0} hinzugefügt.",ENCNTR_MSG:"Zum Durchführen dieser Aktion muss ein Fall geladen sein.",FILTER_MSG:"Beim Speichern der Änderung am Filter ist ein Fehler aufgetreten. Bitte versuchen Sie es erneut.",INACTIVATE:"Deaktivieren",MEDICAL_AND_PATIENT_STATED:"Medizinisch und nach Aussage des Patienten",MOVE_TO:"Zu {0} verschieben",NO_ADD_CONDITION_MSG:"Sie haben keine Berechtigung, diesen Patientenzustand zum Abschnitt {0} hinzuzufügen.",NO_PRIVS_MSG:"Sie haben keine Berechtigung, diese Aktion durchzuführen.",PROBLEM_RETRIEVING_DATA:"Beim Abrufen der {0}-Daten ist ein Fehler aufgetreten",PROBLEM_STATUS:"Beschwerdestatus",PROBLEM_TYPE_FLAG_2_MSG:"Diese Beschwerde kann nur mit der Steuerung für Schwangerschaften und nicht mit der derzeitigen Aktion geändert werden.",PROCESSING:"In Bearbeitung...",RECENT_VISITS:"Letzte Aufenthalte",REMOVE_FROM:"Aus {0} entfernen",RESOLVE:"Berichtigen",NO_ACTION_FREETEXT:"Sie können diese Aktion nicht für eine Freitextlangzeitdiagnose oder Diagnose ausführen."};
...
}i18n.discernabu.past_medical_history_o1={ANNOTATED_DISPLAY:"Name für Anzeige mit Annotationen",CODE:"Kode",COMMENTS:"Kommentare",ONSET_DATE:"Beginndatum",PAST_MEDICAL_DETAILS:"Medizinische Vorgeschichte - Details",PAST_MEDICAL_HISTORY:"Medizinische Vorgeschichte",PAST_PROBLEM:"Langzeitdiagnose",PAST_RESOLVED_DATE:"Auflösungsdatum",STATUS:"Status"};
if(typeof i18n=="undefined"){var i18n={};
}if(typeof i18n.discernabu=="undefined"){i18n.discernabu={};
}i18n.discernabu.patient_background_o1={ATTENDING_PHYSICIAN:"Behandelnder Arzt",SERVICE:"Fachabteilung",RESUSITATION_STATUS:"Reanimationseinwilligung",NO_RESULTS_FOUND:"Keine Ergebnisse gefunden",ADVANCE_DIRECTIVE:"Vorausverfügung",ISOLATION:"Isolierung",TARGET_DISCH_DT_TM:"Geplantes Entlassungsdatum/-zeit",ACTIVITY_ORDER:"Aktivitätsanforderung",PARENT_PART_TYPE:"Beziehung des gesetzlichen Vormunds",GESTATIONAL_AGE:"Gestationsalter",PARA_GRAVIDA:"Para Gravida",FALL_RISK_SCORE:"Fallrisikoskala",ASSISTIVE_DEVICES:"Hilfsgeräte",MULTIPLE:"Mehrfach",DEVICE_DETAILS:"Geräte - Details",SEIZURE_PRECAUTIONS:"Präventionsmaßnahmen für Anfall",DIET:"Kost",PAIN_SCORE:"Schmerzskala",DATE_TIME:"Abnahmedatum/ -zeit",STATUS:"Status"};
if(typeof i18n=="undefined"){var i18n={};
}if(typeof i18n.discernabu=="undefined"){i18n.discernabu={};
}i18n.discernabu.patinfo_o1={NO_RESULTS_FOUND:"Keine Ergebnisse gefunden",RFV:"Aufnahmegrund",ROOM_BED:"Zimmer/Bett",ADMIT_DIAG:"Aufnahmediagnose",ADMIT_DATE:"Aufnahmedatum",PRIM_PHYS:"Hausarzt",ATTEND_PHYS:"Behandelnder Arzt",EMER_CONTACT:"Ansprechpartner für Notfälle",EMER_NUMBER:"Telefonnummer für Notfälle",CODE_STATUS:"Code-Status",LAST_VISIT:"Letzter Aufenthalt",LAST:"Letzte(r)",VISIT:"Aufenthalt",CONTACTS:"Ansprechpartner",ADMIT_PHYS:"Aufnahmearzt",TARGETED_DISCHARGE_DATE:"Geplantes Entlassungsdatum",SERVICE:"Fachabteilung",MODE_OF_ARRVAL:"Ankunftsmodus",ADVANCE_DIRECTIVE:"Vorausverfügung",DETAILS:"Details",CHIEF_COMPLAINT:"Hauptbeschwerde"};
...
}i18n.discernabu.vitals_o1={BLOOD_PRESSURE:"Blutdruck",TEMPERATURE:"Temperatur",HEART_RATE:"Herzfrequenz",DEGC:"Grad Celsius",DEGF:"Grad Fahrenheit",NORMAL_LOW:"Untergrenze Normalbereich",NORMAL_HIGH:"Obergrenze Normalbereich",CRITICAL_LOW:"Kritischer Minimalwert",CRITICAL_HIGH:"Kritischer Maximalwert",TWO_DAY_MAX:"Höchstwert innerhalb 48 Stunden",LATEST:"Letzte/r/s",WITHIN:"innerhalb von",PREVIOUS:"Vorherige/r/s",DATE_TIME:"Datum/Zeit",ERROR_RETREIVING_DATA:"Fehler beim Suchen der Ergebnisse",VALUE:"Wert",LABORATORY_DETAILS:"Laborergebnisse - Details",LOADING_DATA:"Ladevorgang",STATUS:"Status",TWO_DAY_MIN:"Niedrigster Wert innerhalb 48 Stunden"};
if(typeof i18n=="undefined"){var i18n={};
}if(typeof i18n.discernabu=="undefined"){i18n.discernabu={};
}i18n.discernabu.weights_o1={LATEST:"Letzte/r/s",WITHIN:"innerhalb von",PREVIOUS:"Vorherige",CHANGE:"Änderung",ADMISSION:"Aufnahme",MEASUREMENT_DETAILS:"Messung - Details",NAME:"Name",RESULT:"Ergebnis",DATE_TIME:"Datum/Zeit",STATUS:"Status"};
