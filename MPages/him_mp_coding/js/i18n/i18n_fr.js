...
}i18n.discernabu.consolproblem_o1={ADD_NEW_AS:"Ajouter nouveau à :",ALL:"Tous",AND:"et",CANCEL:"Annuler",CHANGE_TO_MEDICAL:"Définir sur Médical",CLASSIFICATION:"Classification",CONDITION:"État",CONFIRM:"Confirmer",DIAGNOSIS_DETAILS:"Détails du diagnostic",DUPLICATE_MSG:"Cette action créerait un doublon dans la section {0}.  La maladie ne sera pas ajoutée à la section {0}.",ENCNTR_MSG:"Un séjour doit être chargé pour pouvoir effectuer cette action.",FILTER_MSG:"Problème d'enregistrement des modifications du filtre. Veuillez réessayer.",INACTIVATE:"Désactiver",MEDICAL_AND_PATIENT_STATED:"Médical et Fourni par le patient",MOVE_TO:"Déplacer vers {0}",NO_ADD_CONDITION_MSG:"Vous ne disposez pas des droits appropriés pour ajouter cette maladie à la section {0}.",NO_PRIVS_MSG:"Vous ne disposez pas des droits appropriés pour effectuer cette action.",PROBLEM_RETRIEVING_DATA:"Problème de récupération des données {0}",PROBLEM_STATUS:"Statut du problème",PROBLEM_TYPE_FLAG_2_MSG:"Ce problème peut être modifié uniquement via la commande de grossesse, il ne sera donc pas modifié par l'action en cours.",PROCESSING:"Traitement en cours.",RECENT_VISITS:"Consultations récentes",REMOVE_FROM:"Supprimer de {0}",RESOLVE:"Résoudre",NO_ACTION_FREETEXT:"Vous ne pouvez pas effectuer cette action sur un problème ou un diagnostic en texte libre."};
...
}i18n.discernabu.immunization={IMMUNIZATIONS_DETAILS:"D�tails sur la vaccination",IMMUNIZATIONS:"Vaccination",TYPE:"Type",STATUS:"Statut",PRODUCT:"Produit",ADMIN_DATE:"Date d'administration",DOCUMENTED_BY:"Document� par",DETAILS:"D�tails",MANUFACTURER:"Fabricant",LOT:"Lot",EXP_DATE:"Date de p�remption",ADMIN_NOTES:"Notes d'administration"};
if(typeof i18n=="undefined"){var i18n={};
}if(typeof i18n.discernabu=="undefined"){i18n.discernabu={};
}i18n.discernabu.laboratory_o1={WITHIN:"dans",LATEST:"Dernier résultat",PREVIOUS:"Précédent",EXPAND:"Développer",COLLAPSE:"Réduire",PRIMARY_RESULTS:"Résultats principaux",SECONDARY_RESULTS:"Résultats secondaires",VALUE:"Valeur",LABORATORY_DETAILS:"Détails de laboratoire",DATE_TIME:"Date/Heure",NORMAL_LOW:"Normal faible",NORMAL_HIGH:"Normal élevé",CRITICAL_LOW:"Critique faible",CRITICAL_HIGH:"Critique élevé",STATUS:"Statut"};
...
}i18n.discernabu.vitals_o1={BLOOD_PRESSURE:"Pression artérielle",TEMPERATURE:"Température",HEART_RATE:"Hre",DEGC:"DegC",DEGF:"DegF",NORMAL_LOW:"Normal faible",NORMAL_HIGH:"Normal élevé",CRITICAL_LOW:"Critique faible",CRITICAL_HIGH:"Critique élevé",TWO_DAY_MAX:"48 heures maximum",LATEST:"Dernier résultat",WITHIN:"dans",PREVIOUS:"Précédent",DATE_TIME:"Date/Heure",ERROR_RETREIVING_DATA:"Erreur de récupération des résultats",VALUE:"Valeur",LABORATORY_DETAILS:"Détails de laboratoire",LOADING_DATA:"Chargement",STATUS:"Statut",TWO_DAY_MIN:"48 heures minimum"};
if(typeof i18n=="undefined"){var i18n={};
}if(typeof i18n.discernabu=="undefined"){i18n.discernabu={};
}i18n.discernabu.weights_o1={LATEST:"Dernier résultat",WITHIN:"dans",PREVIOUS:"Précédent",CHANGE:"Évolution",ADMISSION:"Admission",MEASUREMENT_DETAILS:"Détails des mesures",NAME:"Nom",RESULT:"Résultat",DATE_TIME:"Date/Heure",STATUS:"Statut"};
