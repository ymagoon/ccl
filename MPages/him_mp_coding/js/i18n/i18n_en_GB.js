...
}i18n.discernabu.past_medical_history_o1={ANNOTATED_DISPLAY:"Annotated Display Name",CODE:"Code",COMMENTS:"Comments",ONSET_DATE:"Onset Date",PAST_MEDICAL_DETAILS:"Past Medical History Details",PAST_MEDICAL_HISTORY:"Past Medical History",PAST_PROBLEM:"Problem",PAST_RESOLVED_DATE:"Resolved Date",STATUS:"Status"};
if(typeof i18n=="undefined"){var i18n={};
}if(typeof i18n.discernabu=="undefined"){i18n.discernabu={};
}i18n.discernabu.patient_background_o1={ATTENDING_PHYSICIAN:"Lead Clinician",SERVICE:"Service",RESUSITATION_STATUS:"Resuscitation Status",NO_RESULTS_FOUND:"No results found",ADVANCE_DIRECTIVE:"Advance Directive",ISOLATION:"Isolation",TARGET_DISCH_DT_TM:"Target Discharge Date Time",ACTIVITY_ORDER:"Activity Order",PARENT_PART_TYPE:"Legal Guardian Reltn",GESTATIONAL_AGE:"Gestational Age",PARA_GRAVIDA:"Para Gravida",FALL_RISK_SCORE:"Fall Risk Score",ASSISTIVE_DEVICES:"Assistive Devices",MULTIPLE:"Multiple",DEVICE_DETAILS:"Device Details",SEIZURE_PRECAUTIONS:"Seizure Precautions",DIET:"Diet",PAIN_SCORE:"Pain Score",DATE_TIME:"Date/Time",STATUS:"Status"};
if(typeof i18n=="undefined"){var i18n={};
}if(typeof i18n.discernabu=="undefined"){i18n.discernabu={};
}i18n.discernabu.patinfo_o1={NO_RESULTS_FOUND:"No results found",RFV:"Reason For Visit",ROOM_BED:"Room/Bed",ADMIT_DIAG:"Admitting Diagnosis",ADMIT_DATE:"Admit Date",PRIM_PHYS:"GP",ATTEND_PHYS:"Lead Clinician",EMER_CONTACT:"Emergency Contact",EMER_NUMBER:"Emergency No.",CODE_STATUS:"Code Status",LAST_VISIT:"Last Visit",LAST:"Last",VISIT:"Visit",CONTACTS:"Contacts",ADMIT_PHYS:"Admitting Clinician",TARGETED_DISCHARGE_DATE:"Targeted Discharge Date",SERVICE:"Service",MODE_OF_ARRVAL:"Mode of Arrival",ADVANCE_DIRECTIVE:"Advance Directive",DETAILS:"Details",CHIEF_COMPLAINT:"Chief Complaint"};
...
}i18n.discernabu.weights_o1={LATEST:"Latest",WITHIN:"within",PREVIOUS:"Previous",CHANGE:"Change",ADMISSION:"Admission",MEASUREMENT_DETAILS:"Measurement Details",NAME:"Name",RESULT:"Result",DATE_TIME:"Date/Time",STATUS:"Status"};
