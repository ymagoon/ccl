...
var reg_Observation_i18n=function(){return{reg_obsrv_ADD_EXC_TIME:"Add Exclusion Time",reg_obsrv_ADD_ORDER:"Add Order",reg_obsrv_CANCEL:"Cancel",reg_obsrv_CANCEL_DC:"Cancel D/C",reg_obsrv_CHARGED:"Charged",reg_obsrv_COMPLETE:"Complete",reg_obsrv_CONFIRMATION_MESSAGE:"Are you sure you want to delete this exclusion?",reg_obsrv_DAYS:" day(s)",reg_obsrv_DATE:"Date",reg_obsrv_DELETE:"Delete",reg_obsrv_DISCHARGE_DATE:"Discharge Date",reg_obsrv_DISPLAY:"Display",reg_obsrv_DURATION:"Duration: ",reg_obsrv_DURATION_MEASUREMENT:"DURATION TYPE:",reg_obsrv_END_DATE:"End Date: ",reg_obsrv_END_TIME:"End Time: ",reg_obsrv_EVENT_DATE:"Event Date",reg_obsrv_EXCLUSION:"Exclusion",reg_obsrv_EXCLUSION_DESC:"Exclusion Description",reg_obsrv_EXCLUSION_TIME:"Exclusion Time",reg_obsrv_EXPECTED:"Expected",reg_obsrv_FAIL_MESSAGE:"Unable to retrieve data. Please try again. If the problem persist, contact your system administrator.",reg_obsrv_HR:" hr ",reg_obsrv_HRS:" hrs ",reg_obsrv_LOAD_ERROR:" Load Error",reg_obsrv_MIN:" min ",reg_obsrv_NA:"N/A",reg_obsrv_NO:"No",reg_obsrv_NO_OBSERVATION_EVENTS:"No observation events have been recorded.",reg_obsrv_OBSERVATION:"Observation",reg_obsrv_OBSERVATION_EVENTS:"OBSERVATION EVENTS",reg_obsrv_OK:"OK",reg_obsrv_ORDER:"Order",reg_obsrv_ORDER_DESC:"Order Description: ",reg_obsrv_ORDER_STATUS:"Order Status",reg_obsrv_PLEASE_CONFIRM:" Please Confirm",reg_obsrv_ROOMBED:"Room/Bed",reg_obsrv_SAVE:"Save",reg_obsrv_SAVE_ERROR:"Save Error",reg_obsrv_SAVE_ERROR_MESSAGE:"The system was unable to save the data. Select Save again. If the problems persist, contact your system administrator.",reg_obsrv_SHOW_INACTIVE:" Show Inactive",reg_obsrv_STALE_DATA_ERROR:"Save Failed",reg_obsrv_STALE_DATA_ERROR_MESSAGE:"The selected exclusion information has been changed since opening.  Your changes cannot be saved.  Refresh the page to view the changes and continue modifications. ",reg_obsrv_START_DATE:"Start Date: ",reg_obsrv_START_DATE_TIME:"Start D/T: ",reg_obsrv_START_TIME:"Start Time:",reg_obsrv_TIME:"TIME: ",reg_obsrv_TOTALS:"Totals",reg_obsrv_TRANSACTION_DATE:"Transaction D/T: ",reg_obsrv_YES:"Yes"};
}();
