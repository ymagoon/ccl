...
i18n.AUTO_REFRESH="Actualización automática";
...
i18n.ED_VOLUME="Volumen DU";
i18n.ED_VOLUME_DETAIL="Cuadro de diálogo Detalles de volumen DU";
i18n.EKG="ECG";
...
i18n.LENGTH_OF_STAY_DETAIL="Cuadro de diálogo Detalles de duración de la estancia";
...
i18n.PENDING_ADMITS="Admisiones pendientes";
i18n.PENDING_ADMITS_DETAIL="Cuadro de diálogo Detalles de admisiones pendientes";
i18n.PENDING_ORDERS="Pacientes con Indicaciones pendientes";
i18n.PENDING_ORDERS_DETAIL="Cuadro de diálogo Detalles de pacientes con indicaciones pendientes";
...
i18n.SAVE_AS_DEF_LOCATION="Guardar como ubicación predeterminada";
...
i18n.WAITING_ROOM="Sala de espera";
i18n.WAITING_ROOM_DETAIL="Cuadro de diálogo Detalles de sala de espera";
...
i18n.discernabu.DEFAULT_EXPANDED="Expandido de forma predeterminada";
...
i18n.TRACKING_GROUP="Grupo de seguimiento";
...
}i18n.discernabu.mpage_realtime_dashboard_i18n={ACUITY:"Gravedad",AT_CAPACITY:"A plena capacidad",AVG_ACUITY:"Gravedad media",BOARDING_TIME:"Hora de internación",BOARDING_TIME_TARGET:"Hora de internación objetivo",COMMENTS:"Comentarios",CRITICAL_OVERDUE:"Vencimiento crítico",CRITICAL_PATIENTS:"Pacientes críticos",DISCHARGE_PENDING_CRITICAL_OVERDUE:"Alta pendiente extremamente vencida",DISCHARGE_PENDING_OVERDUE:" Alta pendiente vencida",DISCHARGE_PENDING_TARGET:"Objetivo de alta pendiente",DISPOSITIONS:"Disposiciones",GRID_HEADER_TEXT:"Esta lista muestra a todos los pacientes con un valor {component} superior a {mm:hh}",IN_PAT_ROOM_ASSIGNED:"Habitación de paciente interno asignada",KEY:"Clave",LOS:"Nivel de servicio",MEDIAN_SEEN_PER_HOUR:"Media de visitas por hora",MEDIAN_LOS:"Duración media de la estancia",MRN:"NºHªC",NURSE:"Miembro del personal de enfermería",OVERDUE:"Fuera de plazo",OVER_CAPACITY:"Capacidad excedida",PATIENTS:"Pacientes",PATIENT_INFO:"Información del paciente",PENDING_ADMIT:"Admisión pendiente",PENDING_DISCHARGE:"Alta pendiente",PHYSICIAN:"Médico",PHYSICIANS:"Médicos",NURSES:"Enfermeras",REFERRING_COMMENTS:"Comentarios de remisión",RFV:"Razón de la visita",ROOM:"Habitación",TARGET:"Destino",TIME_IN_STATUS_TARGET:"Objetivo de tiempo transcurrido",TIME_IN_STATUS:"Tiempo transcurrido",WAIT_TIME:"Tiempo de espera",WAIT_TIME_TARGET:"Tiempo de espera objetivo"};
if(typeof i18n=="undefined"){var i18n={};
}if(typeof i18n.discernabu=="undefined"){i18n.discernabu={};
}if(typeof i18n=="undefined"){var i18n={};
}if(typeof i18n.discernabu=="undefined"){i18n.discernabu={};
}i18n.discernabu.mpage_realtime_dashboard_i18n={ACUITY:"Gravedad",ADMIN_HIGH:"Administrada con alta prioridad",ADMIN_OVERDUE:"Administrada fuera de plazo",AT_CAPACITY:"A plena capacidad",AVG_ACUITY:"Gravedad media",BOARDING_TIME:"Hora de internación",BOARDING_TIME_TARGET:"Hora de internación objetivo",COLLECT_HIGH:"Tomada con alta prioridad",COLLECT_OVERDUE:"Tomada fuera de plazo",COMMENTS:"Comentarios",COMPLETE_HIGH:"Finalizado con alta prioridad",COMPLETE_OVERDUE:"Finalizado fuera de plazo",CRITICAL_OVERDUE:"Vencimiento crítico",CRITICAL_PATIENTS:"Pacientes críticos",DISCHARGE_PENDING_CRITICAL_OVERDUE:"Alta pendiente extremamente vencida",DISCHARGE_PENDING_OVERDUE:" Alta pendiente vencida",DISCHARGE_PENDING_TARGET:"Objetivo de alta pendiente",DISPOSITIONS:"Disposiciones",GRID_HEADER_TEXT1:"Esta lista muestra todos los pacientes con una ",GRID_HEADER_TEXT2:" superior a {mm:hh}",IN_PAT_ROOM_ASSIGNED:"Habitación de paciente interno asignada",KEY:"Clave",LOS:"duración de la estancia",MEDIAN_SEEN_PER_HOUR:"Media de visitas por hora",MEDIAN_LOS:"Duración media de la estancia",MRN:"NºHªC",NURSE:"Miembro del personal de enfermería",ORDERS:"Indicaciones",OVERDUE:"Fuera de plazo",OVER_CAPACITY:"Capacidad excedida",PATIENTS:"Pacientes",PATIENT_INFO:"Información del paciente",PENDING_ADMIT:"Admisión pendiente",PENDING_DISCHARGE:"Alta pendiente",PEND_ADMIN:"Administrada pendiente",PEND_COLLECT:"Tomada pendiente",PEND_COMPLETE:"Finalización pendiente",PEND_PRELIM:"Preliminar pendiente",PEND_REPORT:"Informe pendiente",PEND_RESULT:"Resultado pendiente",PHYSICIAN:"Médico",PHYSICIANS:"Médicos",PRELIM_HIGH:"Preliminar con alta prioridad",PRELIM_OVERDUE:"Preliminar fuera de plazo",NURSES:"Enfermeras",REFERRING_COMMENTS:"Comentarios de remisión",REPORT_HIGH:"Informe con alta prioridad",REPORT_OVERDUE:"Informe fuera de plazo",RESULT_HIGH:"Resultado con alta prioridad",RESULT_OVERDUE:"Resultado fuera de plazo",RFV:"Razón de la visita",ROOM:"Habitación",TARGET:"Destino",TIME_IN_STATUS_TARGET:"Objetivo de tiempo transcurrido",TIME_IN_STATUS:"Tiempo transcurrido",WAIT_TIME:"Tiempo de espera",WAIT_TIME_TARGET:"Tiempo de espera objetivo"};
