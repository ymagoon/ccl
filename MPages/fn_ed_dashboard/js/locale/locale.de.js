...
i18n.AUTO_REFRESH="Automatische Aktualisierung";
...
i18n.CONTACT_ADMINISTRATOR="Wenden Sie sich an Ihren Systemverwalter.";
...
i18n.DATE_TIME_INITIATED="Initiiert am/um";
i18n.DAYS="Tage";
...
i18n.DIAGNOSES_DATE="Diagnosedatum";
i18n.DIAGNOSES_NAME="Diagnose";
...
i18n.ED_VOLUME="Notaufnahmevolumen";
i18n.ED_VOLUME_DETAIL="Dialog mit Details zum Notaufnahmevolumen";
i18n.EKG="EKG";
...
i18n.ERROR_TARGET_OBJECT="Zielobjektname";
i18n.ERROR_TARGET_OBJECT_VALUE="Zielobjektwert";
...
i18n.JULY=["Jul.","Juli"];
i18n.JUNE=["Jun.","Juni"];
i18n.KEY_PERSON_RELATIONSHIPS="Beziehungen mit Schlüsselpersonen";
...
i18n.LENGTH_OF_STAY_DETAIL="Dialog mit Details zur Aufenthaltsdauer";
...
i18n.PAGE_ERROR_ACTION="Versuchen Sie, die Seite zu aktualisieren. Falls der Fehler weiterhin auftritt, wenden Sie sich an Ihren Systemverwalter.";
i18n.PAIN="Schmerzen";
...
i18n.PEEP="PEEP";
i18n.PERCENTILE="Perzentil";
i18n.PERSON_NAME_HEADER="Name der Person";
i18n.PE_DATE="Datum:";
i18n.PE_INSTRUCTION="Anweisung:";
i18n.PE_PROVIDER="Mitarbeiter:";
i18n.PENDING_ADMITS="Ausstehende Aufnahmen";
i18n.PENDING_ADMITS_DETAIL="Dialog mit Details zu ausstehenden Aufnahmen";
i18n.PENDING_ORDERS="Patienten mit Ausstehende Anforderungen";
i18n.PENDING_ORDERS_DETAIL="Dialog mit Details zu Patienten mit ausstehenden Anforderungen";
...
i18n.PROCEDURE="Untersuchung";
i18n.PROCEDURE_DATE="Untersuchungsdatum";
i18n.PROCEDURE_DETAILS="Untersuchungsdetails";
i18n.PROCEDURE_NAME="Untersuchung";
i18n.PRODUCT="Produkt";
i18n.PROFSKILLEDSERVICESANTICIPATED="Voraussichtlich benötige Fachdienste";
i18n.PROVIDER="Mitarbeiter";
...
i18n.RCM_INCLUDE_CLOSED_UM_REVIEWS="Mit abgeschlossenen Verwendungsverwaltungsprüfungen";
...
i18n.RCM_PRIMARY_UR_NURSE="Primärer Pfleger für Verwendungsprüfungen";
...
i18n.RCM_TYPE="Typ";
i18n.RCM_UM_INFO="Informationen zur Verwendungsverwaltung";
i18n.RCM_UM_STATUS="Status der Verwendungsverwaltung";
...
i18n.SAVE_AS_DEF_LOCATION="Als Standardstandort speichern";
...
i18n.TARGET_DISCH_DT_TM="Geplante Entlassung am/um";
...
i18n.USER_CUST_DISCLAIMER="Berücksichtigen Sie die Bildschirmauflösung, bevor Sie eine Ansicht mit drei Spalten auswählen.";
i18n.USER_CUST_5_COL_DISCLAIMER="Berücksichtigen Sie die Bildschirmauflösung, bevor Sie eine Ansicht mit fünf Spalten auswählen.";
...
i18n.WAITING_ROOM="Wartezimmer";
i18n.WAITING_ROOM_DETAIL="Dialog mit Details zum Wartezimmer";
...
i18n.discernabu.ERROR_TARGET_OBJECT="Zielobjektname";
i18n.discernabu.ERROR_TARGET_OBJECT_VALUE="Zielobjektwert";
...
i18n.discernabu.ICU_DASHBOARD="Physiologieansicht";
...
i18n.discernabu.NO_VIEWS_DEFINED="Für diese Seite wurden keine Ansichten festgelegt. Benachrichtigen Sie Ihren Datenbankverwalter.";
...
i18n.TRACKING_GROUP="Aufenthaltsgruppe";
i18n.discernabu.USER_CUSTOMIZATION="Benutzerspezifische Anpassung";
i18n.discernabu.USER_CUST_DISCLAIMER="Berücksichtigen Sie die Bildschirmauflösung, bevor Sie eine Ansicht mit drei Spalten auswählen.";
i18n.discernabu.USER_CUST_5_COL_DISCLAIMER="Berücksichtigen Sie die Bildschirmauflösung, bevor Sie eine Ansicht mit fünf Spalten auswählen.";
i18n.discernabu.VIEW_LAYOUT="Layout anzeigen";
i18n.discernabu.VIEW_SELECTOR="Ansichtsauswahl";
i18n.discernabu.VIEW_NOT_SELECTED="Es wurde keine benutzerdefinierte Ansicht ausgewählt. Wählen Sie eine Ansicht aus.";
...
i18n.discernabu.CODE_LEVEL="Diese Funktionalität wird für den vorliegenden Kodelevel nicht unterstützt. Wenden Sie sich an den Systemverwalter.";
...
}i18n.discernabu.mpage_realtime_dashboard_i18n={ACUITY:"Schweregrad",AT_CAPACITY:"Kapazität erreicht",AVG_ACUITY:"Durchschnittlicher Schweregrad",BOARDING_TIME:"Aufnahmewartezeit",BOARDING_TIME_TARGET:"Zielaufnahmewartezeit",COMMENTS:"Kommentare",CRITICAL_OVERDUE:"Kritisch überfällig",CRITICAL_PATIENTS:"Kritische Patienten",DISCHARGE_PENDING_CRITICAL_OVERDUE:"Entlassung ausstehend - Kritisch überfällige",DISCHARGE_PENDING_OVERDUE:" Entlassung ausstehend - Überfällig",DISCHARGE_PENDING_TARGET:"Entlassung ausstehend - Ziel",DISPOSITIONS:"Zustände",GRID_HEADER_TEXT:"Diese Liste zeigt alle Patienten mit einer {Komponente} von länger als {mm:hh} an.",IN_PAT_ROOM_ASSIGNED:"Patientenzimmer zugewiesen",KEY:"Schlüssel",LOS:"Aufenthaltsdauer",MEDIAN_SEEN_PER_HOUR:"Durchschnittlich Behandelte pro Stunde",MEDIAN_LOS:"Medianwert der Aufenthaltsdauer",MRN:"Patientennummer",NURSE:"Pflegepersonal",OVERDUE:"Überfällig",OVER_CAPACITY:"Über Kapazität",PATIENTS:"Patienten",PATIENT_INFO:"Patienteninformationen",PENDING_ADMIT:"Ausstehende Aufnahme",PENDING_DISCHARGE:"Ausstehende Entlassung",PHYSICIAN:"Arzt",PHYSICIANS:"Ärzte",NURSES:"Pflegepersonal",REFERRING_COMMENTS:"Kommentare zur Überweisung",RFV:"Aufnahmegrund",ROOM:"Zimmer",TARGET:"Ziel",TIME_IN_STATUS_TARGET:"Ziel für Zeit in Status",TIME_IN_STATUS:"Zeit in Status",WAIT_TIME:"Wartezeit",WAIT_TIME_TARGET:"Zielwartezeit"};
if(typeof i18n=="undefined"){var i18n={};
}if(typeof i18n.discernabu=="undefined"){i18n.discernabu={};
}if(typeof i18n=="undefined"){var i18n={};
}if(typeof i18n.discernabu=="undefined"){i18n.discernabu={};
}i18n.discernabu.mpage_realtime_dashboard_i18n={ACUITY:"Schweregrad",ADMIN_HIGH:"Verabreichung - Hoch",ADMIN_OVERDUE:"Verabreichung - Überfällig",AT_CAPACITY:"Kapazität erreicht",AVG_ACUITY:"Durchschnittlicher Schweregrad",BOARDING_TIME:"Zielaufnahmewartezeit",BOARDING_TIME_TARGET:"Zielaufnahmewartezeit",COLLECT_HIGH:"Abnahme - Hoch",COLLECT_OVERDUE:"Abnahme - Überfällig",COMMENTS:"Kommentare",COMPLETE_HIGH:"Abschluss - Hoch",COMPLETE_OVERDUE:"Abschluss - Überfällig",CRITICAL_OVERDUE:"Kritisch überfällig",CRITICAL_PATIENTS:"Kritische Patienten",DISCHARGE_PENDING_CRITICAL_OVERDUE:"Entlassung ausstehend - Kritisch überfällig",DISCHARGE_PENDING_OVERDUE:" Entlassung ausstehend - Überfällig",DISCHARGE_PENDING_TARGET:"Entlassung ausstehend - Ziel",DISPOSITIONS:"Zustände",GRID_HEADER_TEXT1:"Diese Liste zeigt alle Patienten an mit einer ",GRID_HEADER_TEXT2:" größer als {mm:hh}",IN_PAT_ROOM_ASSIGNED:"Patientenzimmer zugewiesen",KEY:"Legende",LOS:"Aufenthaltsdauer",MEDIAN_SEEN_PER_HOUR:"Durchschnittlich Behandelte pro Stunde",MEDIAN_LOS:"Durchschnittliche Aufenthaltsdauer",MRN:"Patientennummer",NURSE:"Pflegepersonal",ORDERS:"Anforderungen",OVERDUE:"Überfällig",OVER_CAPACITY:"Über Kapazität",PATIENTS:"Patienten",PATIENT_INFO:"Patienteninformationen",PENDING_ADMIT:"Aufnahme ausstehend",PENDING_DISCHARGE:"Entlassung ausstehend",PEND_ADMIN:"Verabreichung - Aussstehend",PEND_COLLECT:"Abnahme - Aussstehend",PEND_COMPLETE:"Abschluss ausstehend",PEND_PRELIM:"Vorläufiger Befund - Aussstehend",PEND_REPORT:"Befund - Aussstehend",PEND_RESULT:"Ergebnis - Ausstehend",PHYSICIAN:"Arzt",PHYSICIANS:"Ärzte",PRELIM_HIGH:"Vorläufiger Befund - Hoch",PRELIM_OVERDUE:"Vorläufiger Befund - Überfällig",NURSES:"Pflegepersonal",REFERRING_COMMENTS:"Kommentare zur Überweisung",REPORT_HIGH:"Befund - Hoch",REPORT_OVERDUE:"Befund - Überfällig",RESULT_HIGH:"Ergebnis - Hoch",RESULT_OVERDUE:"Ergebnis - Überfällig",RFV:"Aufnahmegrund",ROOM:"Zimmer",TARGET:"Ziel",TIME_IN_STATUS_TARGET:"Ziel für Zeit in Status",TIME_IN_STATUS:"Zeit in Status",WAIT_TIME:"Wartezeit",WAIT_TIME_TARGET:"Zielwartezeit"};
