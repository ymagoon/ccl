/**
 * Driver for the Utilization Management modify component when launched from within the Denied 
...
function RenderPage() {
    ...
    deniedDaysListComponent.setPlusAddEnabled(false);
	...
	utilManModifyComponent.addSaveListener(function() {
		RCM_Clinical_Util.forwardNextMPage(criterion,"rcm_denied_days.html");
	});
    ...
    RCM_Clinical_Util.componentInsertData(mPage, [utilManModifyComponent], "MP_UM_DENIALS", mpageName);
};