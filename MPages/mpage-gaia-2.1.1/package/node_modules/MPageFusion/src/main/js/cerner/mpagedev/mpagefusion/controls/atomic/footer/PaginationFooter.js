 ...
 * @private
 */
const getNavigationButton = (type, { isDisabled }) => new Button({
    disabled: isDisabled,
    display: displayByType[ type ],
...
const updateRightSectionButtons = (ctx) => () => {
    ctx.getChild("base")
        .setProp("rSection", new Container({}, [
            ...
            // previous button
            getNavigationButton("PREVIOUS", { isDisabled: ctx.getProp("isPreviousDisabled") }),
            // next button
            getNavigationButton("NEXT", { isDisabled: ctx.getProp("isNextDisabled") }),
            // last button
            ...getEdgeButton({
