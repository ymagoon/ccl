...
var _ButtonGroup = require("../../composite/button/ButtonGroup.page");
...
var LOOKBACK_LABEL = ".mpageui-ComponentHeader-lookbackLabel";
...
var ComponentHeaderPage = function (_UIComponentPage) {
    _inherits(ComponentHeaderPage, _UIComponentPage);

    function ComponentHeaderPage() {
        _classCallCheck(this, ComponentHeaderPage);

        return _possibleConstructorReturn(this, (ComponentHeaderPage.__proto__ || Object.getPrototypeOf(ComponentHeaderPage)).apply(this, arguments));
    }
    ...
    _createClass(ComponentHeaderPage, [{
        ...
        */
        ...
        key: "lookbackLabel",
        get: function get() {
            return this.getNestedElement(LOOKBACK_LABEL).then(function (element) {
                return element.getText();
            });
        }
        ...
        */
        ...
        get: function get() {
            return new _Button2.default(this.driver, {
                selectorList: this.selectorList.concat(SPLIT_BUTTON),
        ...
        */
        ...
        key: "plusAddPopup",
        get: function get() {
            return new _Popup2.default(this.driver, {
        ...
        */
        ...
        key: "toggleButtons",
        get: function get() {
            return new _ButtonGroup2.default(this.driver, {
        ...
        */
        ...
        /** dependency on ResponsiveButtonGroupPageObject
        get lookbackOptions() {
            //To-be-implemented
        }
        */
