...
mp_formatter.DateTimeFormatter.FULL_DATE_TIME_NO_YEAR=10;
 ...
 $('#dtTmHdr').text(graphi18n.DATE_TIME);
 $('#resHdr').text(graphi18n.RESULT); 
        ...
        $(".flot-graph").bind("plothover", function(event, pos, item){
            ...
            if (item) {
                if (previousPoint != item.datapoint) {
					...
					if (!isBP) {
                       ...
                       if (graphDetails.NORM_LOW != "&nbsp" || graphDetails.NORM_HIGH != "&nbsp" || graphDetails.CRIT_LOW != "&nbsp" || graphDetails.CRIT_HIGH != "&nbsp") {
                        ...
                        if (mappedData.MAX48HTEMP) {
                            ...
                            var tempDate = new Date();
                            tempDate.setISO8601(valDate);
                            arMaxTemp.push("<dt><span>",graphi18n.TWO_DAY_MAX,":</span></dt><dd><span class='", max48HNormalcy, "'>", mappedData.MAX48HTEMP, "</span><span>&nbsp" ,df.format(tempDate,mp_formatter.DateTimeFormatter.FULL_DATE_TIME_4YEAR) ,"</span></dd>");
                    ...
                    ar.push("<div class='hvr'><dl><dt><span>", displayEvent, ":</span></dt><dd><span class='", normalcy, "'>", nf.format(y, "."+yPrec), " " + graphDetails.UNITS, "</span></dd><br/><dt><span>",graphi18n.RESULT_DT_TM ,":</span></dt><dd><span>", dateTime, "</span></dd><br/><dt><span>",graphi18n.STATUS , ":</span></dt><dd><span>", graphDetails.STATUS, "</span></dd>");
