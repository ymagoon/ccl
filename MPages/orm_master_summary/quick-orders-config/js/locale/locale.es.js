...
i18n.discernabu.covc_o1 = {
	...
	ALL_UNSAVED_DATA: "Se perderán todos los datos no guardados.",
	ALLOWED_CHARS: "Solo letras, números, espacios y guiones bajos.",
	AVAIL_FOLDERS: "Carpetas disponibles",
	BLANK_VIEW: "El nombre de vista no puede estar vacío.",
	COLOR_BROWN: "Marrón",
	COLOR_DEFAULT: "Predeterminado",
	COLOR_GREEN: "Verde",
	COLOR_GREY: "Gris",
	COLOR_LOWLIGHT: "Luz baja",
	...
	CONFIRM_ADD_VIEW: "¿Realmente desea agregar una nueva vista?",
	CONFIRM_CHANGE_VIEW: "¿Realmente desea cambiar de vista?",
	CONFIRM_REMOVE_VIEW: "Está a punto de eliminar la vista actual.",
    CONTACT_ADMIN: "Contáctese con el administrador",
    DEFAULT: "Predeterminado",
    DELETE_CURRENT_VIEW: "Eliminar vista actual",
    DUPLICATE_VIEW_MESSAGE: "El nombre seleccionado es un duplicado de una vista existente.",
    ERROR: "Error",
    ERROR_SAVING: "Error al guardar preferencias de usuario",
    ERROR_RETRIEVING: "Error al recuperar preferencias de usuario",
    FAILED_VALIDATION: "Error de validación",
    GET_VIEW_TO_ADD: "Ver nombre",
    GET_RENAME_VIEW: "Escriba un nombre nuevo para la vista actual llamada {name}.",
	MENU_COLOR_HOVER: "Seleccionar color",
    NO_RESULTS_FOUND: "No se encuentran resultados",
    PLEASE_TRY_AGAIN: "Inténtelo de nuevo.",
    PROCEED: "¿Desea proceder?",
    QUICK_ORDERS_CUST_TITLE: "Configuración de indicaciones rápidas y cargos",
    REENTER_VIEW: "Vuelva a escribir el nombre de vista usando solo letras, números, espacios o guiones bajos.",
    RENAME_VIEW: "Renombrar vista",
    RENAME_VIEW_SUCCESS: "Vista renombrada correctamente",
    SAVE_VIEW: "Guardar",
    SAVED_SUCCESSFULLY: "Guardado correctamente",
    SELECTED_FOLDERS: "Carpetas seleccionadas",
    SELECTED_VIEW: "Vistas seleccionadas",
    SIGN: "Firmar",
    SPECIAL_CHARS: "No se permiten caracteres especiales.",
    STATUS: "Estado",
    UNIQUE_VIEW_NAME: "Escriba un nombre de vista único.",
    UPDATE_VIEW: "Actualizar vista",
    VIEW: "Ver",
    VIEW_REMOVED_SUCCESS: "La vista se quitó correctamente"
};