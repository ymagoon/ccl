...
i18n.discernabu.covc_o1 = {
	ADD_NEW_VIEW: "Neue Ansicht hinzufügen",
	ALL_UNSAVED_DATA: "Alle nicht gespeicherten Änderungen gehen verloren.",
	ALLOWED_CHARS: "Nur Buchstaben, Leerstellen und Unterstriche.",
	AVAIL_FOLDERS: "Verfügbare Ordner",
	BLANK_VIEW: "Name für Ansicht kann nicht leer sein.",
	COLOR_BROWN: "Braun",
	COLOR_DEFAULT: "Standard",
	COLOR_GREEN: "Grün",
	COLOR_GREY: "Grau",
	COLOR_LOWLIGHT: "Lowlight",
	...
	CONFIRM_ADD_VIEW: "Möchten Sie wirklich eine neue Ansicht hinzufügen?",
	CONFIRM_CHANGE_VIEW: "Möchten Sie wirklich die Ansicht ändern?",
	CONFIRM_REMOVE_VIEW: "Sie sind im Begriff, die aktuelle Ansicht zu löschen.",
    CONTACT_ADMIN: "Bitte wenden Sie sich an Ihren Systemverwalter.",
    DEFAULT: "Standard",
    DELETE_CURRENT_VIEW: "Aktuelle Ansicht löschen",
    DUPLICATE_VIEW_MESSAGE: "Der ausgewählte Name ist bereits für eine Ansicht vorhanden.",
    ERROR: "Fehler",
    ERROR_SAVING: "Fehler beim Speichern der Benutzervoreinstellungen",
    ERROR_RETRIEVING: "Fehler beim Abrufen der Benutzervoreinstellungen",
    FAILED_VALIDATION: "Validierung fehlgeschlagen",
    GET_VIEW_TO_ADD: "Namen anzeigen",
    GET_RENAME_VIEW: "Bitte geben Sie einen neuen Namen für die aktuelle Ansicht {Name} ein.",
	MENU_COLOR_HOVER: "Farbe auswählen",
    NO_RESULTS_FOUND: "Keine Ergebnisse gefunden",
    PLEASE_TRY_AGAIN: "Versuchen Sie es erneut.",
    PROCEED: "Möchten Sie fortfahren?",
    QUICK_ORDERS_CUST_TITLE: "Schnellanforderungen und Leistungen konfigurieren",
    REENTER_VIEW: "Geben Sie den Namen für die Ansicht erneut ein. Verwenden Sie nur Buchstaben, Nummern, Leerstellen oder Unterstriche.",
    RENAME_VIEW: "Ansicht umbenennen",
    RENAME_VIEW_SUCCESS: "Ansicht erfolgreich umbenannt",
    SAVE_VIEW: "Speichern",
    SAVED_SUCCESSFULLY: "Erfolgreich gespeichert",
    SELECTED_FOLDERS: "Ausgewählte Ordner",
    SELECTED_VIEW: "Ausgewählte Ansicht",
    SIGN: "Abzeichnen",
    SPECIAL_CHARS: "Keine Sonderzeichen gestattet.",
    STATUS: "Status",
    UNIQUE_VIEW_NAME: "Bitte geben Sie einen eindeutigen Namen für die Ansicht ein.",
    UPDATE_VIEW: "Ansicht aktualisieren",
    VIEW: "Ansicht",
    VIEW_REMOVED_SUCCESS: "Ansicht erfolgreich entfernt"
};