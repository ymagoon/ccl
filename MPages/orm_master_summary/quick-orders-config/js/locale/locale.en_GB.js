...
i18n.discernabu.covc_o1 = {
	...
	ALL_UNSAVED_DATA: "All unsaved data will be lost.",
	ALLOWED_CHARS: "Only letters, numbers, spaces, and underscores.",
	AVAIL_FOLDERS: "Available Folders",
	BLANK_VIEW: "View name can't be blank.",
	COLOR_BROWN: "Brown",
	...
	CONFIRM_ADD_VIEW: "Do you really want to add a new view?",
	CONFIRM_CHANGE_VIEW: "Do you really want to change views?",
	CONFIRM_REMOVE_VIEW: "You are about to delete the current view.",
    CONTACT_ADMIN: "Please contact your administrator",
    DEFAULT: "Default",
    DELETE_CURRENT_VIEW: "Delete Current View",
    DUPLICATE_VIEW_MESSAGE: "The selected name is a duplicate of an existing view.",
    ERROR: "Error",
    ERROR_SAVING: "Error saving user preferences",
    ERROR_RETRIEVING: "Error retrieving user preferences",
    FAILED_VALIDATION: "Validation Failed",
    GET_VIEW_TO_ADD: "View Name",
    GET_RENAME_VIEW: "Please enter a new name for the current view called {name}.",
	MENU_COLOR_HOVER: "Select colour",
    NO_RESULTS_FOUND: "No results found",
    PLEASE_TRY_AGAIN: "Please try again.",
    PROCEED: "Would you like to proceed?",
    QUICK_ORDERS_CUST_TITLE: "Quick Orders and Charges Configuration",
    REENTER_VIEW: "Please reenter the view name using only letters, numbers, spaces or underscores.",
    RENAME_VIEW: "Rename View",
    RENAME_VIEW_SUCCESS: "Successfully Renamed View",
    SAVE_VIEW: "Save",
    ...
    VIEW: "View",
    VIEW_REMOVED_SUCCESS: "View Removed Successfully"
};