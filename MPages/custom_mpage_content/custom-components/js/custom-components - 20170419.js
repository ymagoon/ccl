...
baycarefl.labfishbone.prototype.render = function(){ //;begin render
	...
	//var resCnt = 1;
	//target.innerHTML = "Hello World";
	var sTitle = "Custom Labs (rh) - Selected Visit"
	 ...
	 output += "<div class='sub-title-disp'>"+ sTitle +"</div>"
		...
		if (this.data.LAB_RESULT.CBC_CNT > 0){
			output += "<tr><td colspan='2' style='width:70%;text-align:right;'>" +
				"<table class='btest' cellspacing='0' cellpadding='0' style='font-size:10px'><tr>" +
				"<td rowspan='2' style='font-size:11px;width:45px;text-align:right; vertical-align: middle;";
				...
				output += "<td style='width: 10px; '><span  style='font-size:20px;vertical-align:top;position:relative;bottom:-4px;'>\\</span></td>";
		...
		if (this.data.LAB_RESULT.BMP_CNT > 0){
			...
			*/
			...
			output += "<td style='width: 10px;' ><span style='font-size:20px;position:relative;bottom:-4px;'>\/</span></td>";

			output += "<td rowspan='2' style='font-size:11px;width:150px;text-align:left; vertical-align: middle;"; /*push to the left v. do*/
			...
			*/
			...
			output += this.data.LAB_RESULT.BMP[0].CREATININE + "</td>";
				...
				output += "<td style='width: 10px;' ><span style='font-size:20px;position:relative;top:-3px;'>\\</span></td></tr>";
			output += "</table>" +
