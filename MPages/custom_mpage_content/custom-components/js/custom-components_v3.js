...
baycarefl.con_phys.prototype.render = function()
{
	...
	{ 
		output +=   "<table width = '100%'><tr><td class='sub-title-disp'>"+  sTitle +"</td></tr></table>"
			...
			+ "<table class = 'sec-content'width = 100%>"
			+ "<tr class = 'pri-sc-hdr' id='tooltipper'>"
			+ "<td width = '25.0%' align = 'center'>Consulting Physician:</td>"
			+ "<td width = '50.0%' align = 'left'></td>"
			+ "<td width = '25.0%' align = 'center'>Date/Time</td></tr>";
		...
		for (i = 0; i < resCnt; i++)
		{
			...
			output += "<tr background = #000>"
			+ "<td width = '25.0%'></td>"
			+ "<td width = '50.0%' align = 'left'  class = 'baycare_con_phys_name'>"
			+ phy_name + "</td>"
			+ "<td width = '25.0%' align = 'center' class = 'baycare_con_phys_date'>" + beg_eff_date + "</td>"
			+ "</tr>"
		}	
		output += "</table>"
	}
