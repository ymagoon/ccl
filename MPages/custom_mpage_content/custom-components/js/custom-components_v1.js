...
baycarefl.radiology.prototype.render = function(){
	...
	{ 
			...
			+  "<div style='max-height:150px;width:100%;overflow-y:scroll ;overflow-x:scroll;'>"
...
baycarefl.procedure_notes.prototype.render = function(){
	...
	{ 
	 	var output =  "<div class='sub-title-disp'>Selected visit</div>";
	 		output +=  "<div style='max-height:150px;width:100%;overflow-y:scroll ;overflow-x:scroll;'>"
