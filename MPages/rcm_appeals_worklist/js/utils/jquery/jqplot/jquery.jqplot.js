...
(function($) {
    ...
    function jqPlot() {
        ...
        this.init = function(target, data, options) {
			...
			if (data == null || jQuery.isArray(data) == false || data.length == 0 || jQuery.isArray(data[0]) == false) {
   ...
   $.jqplot.ColorGenerator = function(colors) {
    ...
    $.jqplot.LineRenderer.prototype.setGridData = function(plot) {
		...
		//update of whiskerData to pixels if it exists
		var wData = (this.markerRenderer.whiskerData)?this.markerRenderer.whiskerData:[];
		var wArr = [];
		for (var i=0, wLen = wData.length;i<wLen;i++) {
			if (wData[i] !== null && wData[i].length == 3) {
				wArr.push([xp.call(this._xaxis, wData[i][0]), yp.call(this._yaxis, wData[i][1]), yp.call(this._yaxis, wData[i][2])]);
			}
		}
    ...
    */
	...
	jsDate.prototype.addNoDST = function(number, unit) {
    ...
    jsDate.regional = {
        ...
        'ru': {
            monthNames: ['�?¯�?½�?²�?°Ñ€ÑŒ','�?¤�?µ�?²Ñ€�?°�?»ÑŒ','�?œ�?°Ñ€Ñ‚','�?�?�?¿Ñ€�?µ�?»ÑŒ','�?œ�?°�?¹','�?˜ÑŽ�?½ÑŒ','�?˜ÑŽ�?»ÑŒ','�?�?�?²�?³ÑƒÑ�?Ñ‚','�?¡�?µ�?½Ñ‚Ñ�?�?±Ñ€ÑŒ','�?ž�?ºÑ‚Ñ�?�?±Ñ€ÑŒ','�?�?�?¾Ñ�?�?±Ñ€ÑŒ','�?�?�?µ�?º�?°�?±Ñ€ÑŒ'],
            monthNamesShort: ['�?¯�?½�?²','�?¤�?µ�?²','�?œ�?°Ñ€','�?�?�?¿Ñ€','�?œ�?°�?¹','�?˜ÑŽ�?½','�?˜ÑŽ�?»','�?�?�?²�?³','�?¡�?µ�?½','�?ž�?ºÑ‚','�?�?�?¾Ñ�?','�?�?�?µ�?º'],
            dayNames: ['�?²�?¾Ñ�?�?ºÑ€�?µÑ�?�?µ�?½ÑŒ�?µ','�?¿�?¾�?½�?µ�?´�?µ�?»ÑŒ�?½�?¸�?º','�?²Ñ‚�?¾Ñ€�?½�?¸�?º','Ñ�?Ñ€�?µ�?´�?°','Ñ‡�?µÑ‚�?²�?µÑ€�?³','�?¿Ñ�?Ñ‚�?½�?¸Ñ†�?°','Ñ�?Ñƒ�?±�?±�?¾Ñ‚�?°'],
            dayNamesShort: ['�?²Ñ�?�?º','�?¿�?½�?´','�?²Ñ‚Ñ€','Ñ�?Ñ€�?´','Ñ‡Ñ‚�?²','�?¿Ñ‚�?½','Ñ�?�?±Ñ‚'],
            formatString: '%Y-%m-%d %H:%M:%S'
        },
	...
	*/
	jsDate.round = function( unit, option ){
		//unit = "seconds";
		if (unit != null)
		{
			switch (unit.toLowerCase()){
