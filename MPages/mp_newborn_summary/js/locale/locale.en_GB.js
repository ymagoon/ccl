...
i18n = {
    ...
    CUSTOMIZE: "Customise",
    USER_CUSTOMIZATION: "User Customisation",
    ...
    EXPIRATION_DATE_TIME: "Expiry Date/Time",
    ...
    RESPIRATORY_DISCLAIMER: "The displayed Arterial Blood Gas result(s) must be synchronised with the oxygen source FIO2, and/or oxygen flow rate that was being delivered to the patient at the time the sample was obtained.",
    UNKNOWN: "Unknown",
    BE: "B.E.",
    ...
    PRIM_PHYS: "GP",
    ATTEND_PHYS: "Lead Clinician",
    EMER_CONTACT: "Emergency Contact",
    EMER_NUMBER: "Emergency No.",
    ...
    CODE_STATUS: "Code Status",
    SERVICE: "Service",
    ATTENDING_PHYSICIAN: "Lead Clinician",
    ...
    FIRST_24HRS_ED_VISIT: "Results represent the first 24 hours of the A&E visit",
    ...
    //MPage title strings
    ED_SUMMARY: "A&E Summary", //ED Summary v2
    ...
    CAREMANAGERUMPAGE: "Utilisation Review Summary",
    ...
    ANESTHESIA_TYPE: "Anaesthesia Type(s)",
    SURGEON: "Surgeon",
    SURGERY_START: "Surgery Start",
    SURGERY_STOP: "Surgery Stop",
    ANESTH_STOP: "Anaesth Stop",
    ANESTH_START: "Anaesth Start",
    ...
    LENGTH_OF_LABOR: "Length of Labour",
    ...
    ROOM_BED: "Room-Bed",
    ADMIT_DIAG: "Admitting Diagnosis",
    ADMIT_PHYS: "Admitting Clinician",
    PRIM_PHYS: "GP",
    ATTEND_PHYS: "Lead Clinician",
    ...
    IMMUNIZATIONS_DETAILS: "Immunisation Details",
    
    //Meds Recon
    START: "Start",
    STOP: "Stop",
    SIGNATURE_LINE: "Signature Line",
    ORDERING_PHYSICIAN: "Ordering Clinician",
    NEW: "New",
    CONTINUE: "Continue",
    NO_LONGER_TAKING: "No longer taking",
    CONTINUE_WITH_CHANGES: "Continue with changes",
    CONTACT_PHYSICIAN: "Contact clinician prior to taking",
    ...
    BILLING: "Billing",
    OTHER: "Other",
    ORDER_FAVORITE: "Order Favourite",
    ORDER_NAME: "Order Name",
    ORDER_DISPLAY_LINE: "Order Display Line",
    ORDER_PARAMETERS: "Order Parameters",
    NO_MEDS_FAVORITES: "No Meds Favourites Found",
    NO_LABS_FAVORITES: "No Labs Favourites Found",
    NO_IMAGING_FAVORITES: "No Imaging Favourites Found",
    NO_BILLING_FAVORITES: "No Billing Favourites Found",
    NO_OTHER_FAVORITES: "No Other Favourites Found",
    ...
    RCM_ATTENDING_PHYSICIAN: "Lead Clinician",
    ...
    RCM_UTILIZATION_MANAGEMENT: "Utilisation Management",
