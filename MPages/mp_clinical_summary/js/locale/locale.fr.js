...
i18n.discernabu.ADD_PERSONAL_FAV_COMP="Ajouter un dossier personnel favori";
...
i18n.discernabu.REMOVE_PERSONAL_FAV_COMP = "Supprimer le dossier personnel favori";
...
}i18n.discernabu.clinical_summary_o1={APPOINTMENT_CONTINUE : "Continuer",
APPOINTMENT_CANCEL : "Annuler",
APPOINTMENT_TITLE : "Rendez-vous",
APPOINTMENT_DATE : "Date du rendez-vous",
APPOINTMENT_LOCATION : "Emplacement du rendez-vous",
APPOINTMENT_PROVIDER : "Soignant du rendez-vous",
REASON_FOR_VISIT : "Motif de venue",
APPOINTMENT_SUMMARY :"Veuillez sélectionner le rendez-vous lié à ce résumé de consultation.",
PUBLISH : "Publier",
SAVE_AS : "Enregistrer sous",
PRINT : "Imprimer",
CREATE_ERROR : "Impossible de créer le résumé de consultation.  Veuillez contacter l’administrateur système",
RETRIEVE_ERROR : "Impossible de récupérer les données du résumé de consultation.  Veuillez contacter l’administrateur système",
FOLLOW_UP_CARE : "Soins de suivi",
NO_DATA_AVAILABLE : "Aucune donnée n'est disponible pour cette section.",
WITH : "Avec",
ADDRESS : "Adresse",
WHEN : "Quand",
...
SEX : "Sexe",
MRN : "IPP",
ERROR_RETRIEVE:"Impossible de récupérer les données du résumé de consultation.",
DISCHARGE_INSTRUCTIONS: "Instructions à la sortie [Éducation et supports visuels pour le patient]",
CLINICAL_NOTE_ERROR:"Échec d'enregistrement du document.  Veuillez contacter l’administrateur système",
PATIENT_EDUCATION:"Le patient indique verbalement qu'il a compris les instructions données.",
APPOINTMENT_CANCEL_MESSAGE :"La sélection de rendez-vous a été annulée. Le Résumé clinique ne sera pas chargé.",
SAVE : "Enregistrer",
SIGN : "Signer",
CREATE_NEW : "Créer nouveau",
CREATE_NEW_CONFIRM_MSG : "Vous avez choisi de créer un nouveau Résumé de visite. Tous les changements précédents seront perdus. Voulez-vous continuer ?",
PRINT_PREVIEW: "Aperçu d'impression"};
/*
 * Date Format 1.2.3
