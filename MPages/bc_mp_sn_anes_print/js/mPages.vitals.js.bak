function Vitals_loadVitalSigns(spanName)
{
	$MP.getJSON("bc_mp_mvs_vitals_16",function(data){
		...
		output += writeVitalLine('Weight Actual', 	data.VITALS.ACT_WGHT1, 
			data.VITALS.ACT_WGHT1_DT_TM, data.VITALS.ACT_WGHT2, data.ACT_WGHT2_DT_TM)


		if(data.VITALS.PAIN1_DT_TM){
			output += "<tr class='data_row'><td><table style='width:100%;'>" +
				"<tr><td colspan='100%'><strong>Pain Assessment</strong></td></tr>" +
				"<tr style='vertical-align:top;'><td>" + data.VITALS.PAIN1_DT_TM + "</td><td style='width:10px;'>&nbsp;</td>" +
				"<td>Pain Score: " + data.VITALS.PAIN1 +

				(data.VITALS.FLACC_SCALE!=""?"<br />FLACC Scale: " + data.VITALS.FLACC_SCALE:"") +
				(data.VITALS.NPASS_SCALE!=""?"<br />N-Pass Scale: " + data.VITALS.NPASS_SCALE:"") +
				(data.VITALS.NVPS_SCALE!=""?"<br />NVPS Scale: " + data.VITALS.NVPS_SCALE:"") +
				(data.VITALS.PAINAD_SCALE!=""?"<br />PAINAD Scale: " + data.VITALS.PAINAD_SCALE:"") +
				(data.VITALS.WB_SCALE!=""?"<br />Wong-Baker Faces Scale: " + data.VITALS.WB_SCALE:"") +
				
				//"<br />Scale Used: " + data.VITALS.PAIN1_SCALE +
				(data.VITALS.PAIN1_LOCATION!=""?"<br />Pain Location: " + data.VITALS.PAIN1_LOCATION:"") +
	  			"</td></tr>";
			if (data.VITALS.PAIN2_DT_TM){
				output += "<tr><td>" + data.VITALS.PAIN2_DT_TM + "</td><td style='width:10px;'>&nbsp;</td>" +
					"<td>Pain Score: " + data.VITALS.PAIN2 +
					//"<br />Scale Used: " + data.VITALS.PAIN2_SCALE +
					(data.VITALS.PAIN2_LOCATION!=""?"<br />Pain Location: " + data.VITALS.PAIN2_LOCATION:"") +
		  			"</td></tr>";
			}
			output += "</table></td></tr>";
		}
		
		if(data.VITALS.PAINADD_DT_TM){
			output += "<tr class='data_row'><td><table style='width:100%;'>" +
				"<tr><td colspan='100%'><strong>Additional Pain Sites</strong></td></tr>" +
				"<tr style='vertical-align:top;'><td>" + data.VITALS.PAINADD_DT_TM + "</td><td style='width:10px;'>&nbsp;</td>" +
				"<td>Additional Sites: " + 
				
				(data.VITALS.SECONDARY_LOC!=""?"<br />Secondary Location: " + data.VITALS.SECONDARY_LOC:"") +
				(data.VITALS.SECONDARY_INT!=""?"<br />Secondary Intensity: " + data.VITALS.SECONDARY_INT:"") +
				(data.VITALS.ADDPAIN_3_LOC!=""?"<br />Additional Pain 3 Location: " + data.VITALS.ADDPAIN_3_LOC:"") +
				(data.VITALS.ADDPAIN_3_INT!=""?"<br />Additional Pain 3 Intensity: " + data.VITALS.ADDPAIN_3_INT:"") +
				(data.VITALS.ADDPAIN_4_LOC!=""?"<br />Additional Pain 4 Location: " + data.VITALS.ADDPAIN_4_LOC:"") +
				(data.VITALS.ADDPAIN_4_INT!=""?"<br />Additional Pain 4 Intensity: " + data.VITALS.ADDPAIN_4_INT:"") +
