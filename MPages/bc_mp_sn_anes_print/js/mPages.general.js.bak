function General_loadPatientInfo(spanName)
{
	$MP.getJSON("bc_mp_ed_pt_info", function(data){
		var output = "<table class='patient_info_table' style='width:99%;'>";
		output += "<tr class='data_row'><td><span class='highlight'>Patient Name:</span> " + data.PTINFO.PT_NAME + "</td></tr>";
		output += "<tr class='data_row'><td><span class='highlight'>FIN:</span> " + data.PTINFO.PT_FIN + "</td></tr>";
		output += "<tr class='data_row'><td><span class='highlight'>DOB:</span> " + data.PTINFO.PT_DOB + "</td></tr>";
		output += "</table>";
...
function General_loadChiefComplaint(spanName)
{
	$MP.getJSON("bc_mp_mvs_chief_5", function(data){
		...
		output += "<tr class='data_row'><td><span class='highlight'>Pre Arrival Treatments:</span> " + data.CHIEF.PRE_ARRIVAL + "</td></tr>";
...
function General_loadClinicalDocumentation(spanName)
{
