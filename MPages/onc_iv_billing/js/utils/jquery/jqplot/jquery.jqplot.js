...
(function ($)
{
    ...
    */
    function Axis(name)
    {
        ...
        // whether to autoscale on zoom(true), not autoscale on zoom(false), or use initial axis setting(null).
        // default is null
        this.autoscaleOnZoom = null;
        // prop: pad
    ...
    */
    function Series()
    {
        ...
        this._sumy = 0;
        this._sumx = 0;
        /* used to setup axes if replotted */
        this.minX = null;
        this.maxX = null;
        this.minY = null;
        this.maxY = null;
    ...
    */
    function jqPlot()
    {
        ...
        // function to perform before plotting (works on redraw and replot only)
        this.performOnPlot = function () { };
        // function to perform after plotting (works on redraw and replot only)
        ...
        this.init = function (target, data, options)
        {
            ...
            if (options)
            {
                ...
                if (options.performOnPlot)
                    this.performOnPlot = options.performOnPlot;
    ...
    $.jqplot.AxisTickRenderer.prototype.setTick = function (value, axisName, isMinor)
    {
        this.value = value;
        this.axis = axisName;
        this.showDate = (arguments.length == 4 && arguments[3]);
        if (isMinor)
        {
    ...
    $.jqplot.AxisTickRenderer.prototype.draw = function ()
    {
        if (!this.label)
        {
            this.label = this.formatter(this.formatString, this.value, this.showDate);
        }
    ...
    */
    ...
    var instanceMethods = {
        ...
        addNoDST: function (number, unit)
        {
            var aVal = parseFloat(number);
            var rVal = null;
            switch (unit.toLowerCase())
            {
                case "second":
                case "seconds":
                    this.setSeconds(this.getSeconds() + aVal);
                    break;
                case "minute":
                case "minutes":
                    this.setMinutes(this.getMinutes() + aVal);
                    break;
                case "hour":
                case "hours":
                    this.setHours(this.getHours() + aVal);
                    break;
                case "day":
                case "days":
                    this.setDate(this.getDate() + aVal);
                    break;
                case "week":
                case "weeks":
                    var daysFromWeek = aVal * 7;
                    this.setDate(this.getDate() + daysFromWeek);
                    break;
                case "month":
                case "months":
                    this.setMonth(this.getMonth() + aVal);
                    break;
                case "year":
                case "years":
                    this.setYear(this.getYear() + aVal);
                    break;
                default: //assume milliseconds even if unit does not match
                    this.setMilliseconds(this.getMilliseconds() + aVal);
                    break;
            }
            return this;
        },
        ...
        */
        round: function (unit, option)
        {
            ...
            if (unit != null)
            {
                ...
                {
                    case "seconds":
                        this.setSeconds((option == "down") ? 0 : 60);
                        this.setMilliseconds(0);
                        break;
                    case "minutes":
                        this.setMinutes((option == "down") ? 0 : 60);
                        this.setSeconds(0);
                        this.setMilliseconds(0);
                        break;
                    case "hours":
                        this.setHours((option == "down") ? 0 : 24);
                        this.setMinutes(0);
                        this.setSeconds(0);
                        this.setMilliseconds(0);
                        break;
    ...
    Date.create.patterns = [
        ...
        function (str)
        { // 12-hour or 24 hour time with milliseconds
        ...
        function (str)
        {
            ...
            if (match)
            {
                ...
                { // first number is a year
                    nd = match[3];
                    if (m1 < y + centoffset)
                    { // if less than 1 year out, assume it is this century.
                        ny = cent + m1;
                    }
                    else
                    {
    ...
    $.jqplot.MarkerRenderer = nMarkerRenderer;

    // class: $.jqplot.shadowRenderer
    // The default jqPlot shadow renderer, rendering shadows behind shapes.
    $.jqplot.ShadowRenderer = nShadowRenderer;
    ...
    // the shape.
    $.jqplot.ShapeRenderer = nShapeRenderer;
...
function nMarkerRenderer(options)
{
    // Group: Properties
    ...
    this.shadowRenderer = new nShadowRenderer();
    // prop: shapeRenderer
    // Renderer that will draw the marker.
    this.shapeRenderer = new nShapeRenderer();

    this.draw = function (x, y, ctx, options)
    {
        options = options || {};
        switch (this.style)
        {
    ...
    this.drawLine = function (x1, y1, x2, y2, ctx)
    {
        ctx.save();
        ctx.beginPath();
        ctx.moveTo(x1, y1);
    ...
    this.drawUpVee = function (x, y, ctx, fill, options)
    {
        var stretch = 1.2;
    ...
    this.drawDownVee = function (x, y, ctx, fill, options)
    {
        var stretch = 1.2;
        var dx = this.size / 1 / stretch;
        var dy = this.size / 1 * stretch;
    ...
    this.drawDiamond = function (x, y, ctx, fill, options)
    {
        var stretch = 1.2;
    ...
    this.drawStar = function (x, y, ctx, fill, options)
    {
        var stretch = 1.2;
        var dx = this.size / 2 * stretch;
    ...
    this.drawRectangleDiag = function (x, y, ctx, fill, options, direction)
    {
        var stretch = 1.2;
        var dx = this.size / 2 * stretch;
        var dy = this.size / 2 * stretch;
    ...
    this.drawTriangle = function (x, y, ctx, fill, options, direction)
    {
        var stretch = 1.2;
        var dx = this.size / 2 * stretch;
        var dy = this.size / 2 * stretch;
    ...
    this.drawRectangle = function (x, y, ctx, fill, options, direction)
    {
        var stretch = 1.2;
        var dx = this.size / 2 * stretch;
        var dy = this.size / 2 * stretch;
    ...
    this.drawHeart = function (x, y, ctx, fill, options)
    {
        var stretch = 1.5;
        var dx = this.size / 2 * stretch;
        var dy = 0 - (this.size / 2 * stretch);
    ...
    this.drawPlus = function (x, y, ctx, fill, options)
    {
        var stretch = 1.0;
        var dx = this.size / 2 * stretch;
        var dy = this.size / 2 * stretch;
    ...
    this.drawX = function (x, y, ctx, fill, options)
    {
        var stretch = 1.0;
        var dx = this.size / 2 * stretch;
        var dy = this.size / 2 * stretch;
    ...
    this.drawDash = function (x, y, ctx, fill, options)
    {
        var stretch = 1.0;
        var dx = this.size / 2 * stretch;
        var dy = this.size / 2 * stretch;
    ...
    this.drawSquare = function (x, y, ctx, fill, options)
    {
        var stretch = 1.0;
        var dx = this.size / 2 * stretch;
        var dy = this.size / 2 * stretch;
    ...
    this.drawCircle = function (x, y, ctx, fill, options)
    {
...
function nShadowRenderer(options)
{
    // Group: Properties
    ...
    this.draw = function (ctx, points, options)
    {
        ctx.save();
...
function nShapeRenderer(options)
{
