...
i18n.oncology.timeline.view = {
    ...
    REMOVE_RESULTS: 'Voulez-vous supprimer les résultats ?',
	...
	NO_FILTERS_DEFINED:'Aucun filtre de données n&#39;est défini.',
	/*Hyperlink to provide an ability to show hidden results */
	SHOW_HIDDEN_RESULTS: 'Afficher les résultats masqués'
