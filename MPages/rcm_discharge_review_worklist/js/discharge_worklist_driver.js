function RenderPage(){
	...
	var timerCAP = MP_Util.CreateTimer("CAP:RCM_DISCHARGE_WORKLIST.01");
	if(timerCAP){
		timerCAP.stop();
	}
	...
	//var mPage = MP_Bedrock.CreateBedrockMPage("MP_DCM_SUMMARY", componentMapping, criterion);
	
	var controller = new RCM_Controller(criterion);
