...
//			}//end for
			...
			/*Begin Glucose Graph*/
            //alert("arGLUC: " + arGLUC.length + "\n" + arGLUC.join("\n") + "\n\n arPCCBG: " + arPCCBG.length + "\n" + arPCCBG.join("\n") 
            //       + "\n\n arPCGLUCBG: " + arPCGLUCBG.length + "\n" + arPCGLUCBG.join("\n") + "\n\n arPCGLUC: " + arPCGLUC.length + "\n" + arPCGLUC.join("\n"));
			var plot1 = $.jqplot('gluCanvas', [arGLUC, arPCCBG, arPCGLUCBG, arPCGLUC], {	
                grid: {        
        		...
        		legend: {
        			...
        			show: true,
                    showLabels: true,
        			//labels:['Glucose','PC CBG', 'PC Glu-CBG', 'PC Glucose', 'Antideabetic Combinations','Insulin','Meglitinides','SGLT-2 inhibitors','Sulfonylureas'],
        		...
        		highlighter: {
                    ...
                    sizeAdjust: 5,
                    lineWidthAdjust: 15,
    				formatString:  '<div class="graphHover">\
                                    <b>Date: </b>%s<br>\
                                    <b>Result: </b>%d<br>\
                                    <b>Label: </b>%s\
                                    </div>'
            ...
            var arADComb = [];
            var arINS = [['12/03/2018 11:29',10,'insulin regular 10.00 unit(s)']];
            var arMEG = [];
            var arSGLT = [];
            var arSULF = [];
