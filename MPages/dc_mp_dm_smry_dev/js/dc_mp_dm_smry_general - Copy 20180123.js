	...
	try{
		...
		if(graph_comp.CFLAG >= 0){
            ...
            for(var x = 0; x < json_data_poc.GLUC.RESULT_CNT; x++){
                //alert(json_data_poc.GLUC.RESULTS[x].RESULTDTTM);
                ...
                yCur = parseInt(json_data_poc.GLUC.RESULTS[x].RESULT);
                if(yCur > yTmp){
                    yTmp = yCur;
                }
            }
            ...
            //     );
			//var plot1 = $.jqplot('gluCanvas', [   arPCCBG, arGLUC, arPCGLUCBG, arPCGLUC
			var plot1 = $.jqplot('gluCanvas', [   arPCCBG, arGLUC, arPCGLUC
                                                , arINSL, arADComb, arMEG, arSGLT2, arSULF
                                                , arHYPO, arHYPER
                                              ], {	
                grid: {        
				...
				series:[
                    ...
                    //,
					{
						label: 'PC Glucose &nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp\
                    ...
                    ,
					{
						label: 'Sulfonylureas &nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp\
                    ...
                    ,
					{
						label: 'Hyperglycemia Causing Agent &nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp',
						color: '#F71158',
						showLine: false,
						yaxis: 'yaxis',
                        markerOptions: { size: 6, style:"x" }
