...
function loadCompDetails(Obj){
	try{
        ...
        alert("Get Glucose data");
 		json_handler.ajax_request({request:{type:"XMLCCLREQUEST",target:'BC_MP_DM_BC_GRAPH',       parameters:cclParam},response:{type:"JSON",target:fillGraphWrapper}})
...
//			}//end for
			...
			var plot1 = $.jqplot('gluCanvas', [myPoc], {	
