...
i18n.tabs = {
    OUTSIDE_DOCUMENTS: 'Outside Documents',
    SUMMARY: 'Summary'
};

i18n.reconcile = {
    RECONCILE_LINK: 'Reconcile',
    RECONCILIATION_DLG_TITLE: 'Reconciliation View'
};


i18n.commonwell = {
    COMMONWELL_MODAL_LINK: 'CommonWell: Loading...', // Placeholder for now
    COMMONWELL_ENROLLED: 'CommonWell: Enrolled',
    COMMONWELL_NOT_ENABLED: 'CommonWell: Not Enabled',
    COMMONWELL_NOT_ENROLLED: 'CommonWell: Not Enrolled',
    COMMONWELL_NEW_SOURCES: 'CommonWell: New Sources ',
    COMMONWELL_TIMED_OUT: 'CommonWell: Status Timed Out'
};
