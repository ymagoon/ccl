...
var rcm_assignment_worklist_i18n = function(){
    return {
		ASWL_ADD_ASSIGNMENT: "Add Assignment",
		ASWL_ALL: "All",
		ASWL_APPLY: "Apply",
		ASWL_ASCENDING: "Ascending",
		ASWL_ASSIGN: "Assign",
		ASWL_ASSIGNED: "Assigned",
		ASWL_BUILD_ERROR: "Build Error",
		ASWL_BUILD_ERROR_MESSAGE: "The BedRock set up has not been completed for this Mpage.  See your system administrator.",
		ASWL_CANCEL: "Cancel",
		ASWL_CARE_MANAGER: "Care Manager",
		ASWL_CHECKBOX_CARE_MANAGER:"Show Care Manager Relationship",
		ASWL_CHECKBOX_DISCHARGE_PLANNER:"Show Discharge Planner Relationship",
		ASWL_CHECKBOX_DOCUMENTATION_SPECIALIST:"Show Documentation Specialist Relationship",
		ASWL_CLASS: "Class",
		ASWL_CLEAR_SELECTION: "Clear Selection",
		ASWL_CM_NOT_ESTABLISHED_MESSAGE: "The personnel you have selected does not have authority to be assigned as the Care Manager.  Select someone else.",
		ASWL_CM_RELATIONSHIP: "Care Manager Relationship",
		ASWL_CURRENT_ASSIGNMENT:"Current Assignment",
		ASWL_CURRENT_SELECTION:"Current Selection",
        ASWL_DASH:" - ",
		ASWL_DELETE_FAILED: "Unable to Save",
		ASWL_DELETE_FAILED_MESSAGE: "The system was unable to save. Try again.",
		ASWL_DESCENDING: "Descending",
		ASWL_DISCHARGE_PLANNER: "Discharge Planner",
		ASWL_DOCUMENTATION_SPECIALIST: "Documentation Specialist",
		ASWL_DP_NOT_ESTABLISHED_MESSAGE: "The personnel you have selected does not have authority to be assigned as the Discharge Planner.  Select someone else.",
		ASWL_DP_RELATIONSHIP: "Discharge Planner Relationship",
		ASWL_DS_NOT_ESTABLISHED_MESSAGE: "The personnel you have selected does not have authority to be assigned as the Documentation Specialist.  Select someone else.",
		ASWL_DS_RELATIONSHIP: "Documentation Specialist Relationship",
		ASWL_ENCOUNTER_TYPE: "Encounter Type",
		ASWL_ERROR_MESSAGE: "Error Retrieving Data",
        ASWL_FILTER_SETTINGS: "Filter settings",
        ASWL_FILTERS: "Filters",
		ASWL_FIN: "FIN",
		ASWL_FINANCIAL_CLASS: "Financial Class",
        ASWL_LIST_MAINTENANCE: "List Maintenance",
		ASWL_LOCATION: "Location",
        ASWL_NO_ACTIVE_LISTS: "There are no active lists.",
		ASWL_NO_ACTIVE_LISTS_LINE_2: "To manage your patient lists, access ",
		ASWL_NO_PATIENT_LISTS: "There are no patient lists defined in Powerchart.",
		ASWL_NO_RESULTS_FOUND: "No Results Found.",
		ASWL_NURSE_UNIT: "Nurse Unit",
		ASWL_NURSE_UNIT_ROOM_BED: "Nurse Unit/Room/Bed",
		ASWL_OK: "OK",
		ASWL_PATIENT: "Patient",
		ASWL_PATIENT_NAME: "Patient Name",
		ASWL_PATIENT_LIST: "Patient List:",
		ASWL_PATIENTS: "Patients",
		ASWL_PAYER: "Payer",
		ASWL_PRIMARY_SORT: "Primary",
		ASWL_PERSONNEL: "Personnel",
		ASWL_REL_NOT_DEFINED: "Relationship has not been Defined",
		ASWL_REL_NOT_DEFINED_MESSAGE: "A relationship has not been defined to be assigned.  See your system administrator.",
		ASWL_REL_NOT_ESTABLISHED: "Relationship cannot be Established",
		ASWL_REMOVE: "Remove",
		ASWL_REMOVE_ASSIGNMENT:"Remove Assignment",
		ASWL_REMOVE_CONFIRM: "Are you sure you want to remove the selected personnel relationships?",
		ASWL_REMOVE_CONFIRM_SINGULAR: "Are you sure you want to remove the selected personnel relationship?",
		ASWL_REPLACE: "Replace",
		ASWL_REPLACE_ASSIGNMENT: "Replace Assignment",
		ASWL_REPLACE_CONFIRM_BEGIN: "Are you sure you want to replace the selected personnel relationship with ",
		ASWL_REPLACE_CONFIRM_BEGIN_SINGULAR: "Are you sure you want to replace the selected personnel relationship with ",
		ASWL_REPLACE_CONFIRM_MIDDLE: " on these ",
		ASWL_REPLACE_CONFIRM_MIDDLE_SINGULAR: " on this ",
		ASWL_REPLACE_CONFIRM_END: " relationships?",
		ASWL_REPLACE_CONFIRM_END_SINGULAR: " relationship?",
		ASWL_REPLACE_RELATIONSHIPS: "Replace Relationships",
		ASWL_SAVE_CONFIGURATION: "Save configuration as default",
		ASWL_SAVE_FAILED: "Save Failed",
		ASWL_SAVE_FILTERS_FAILED_MESSAGE: "Filter settings failed to save.",
		ASWL_SECONDARY_SORT: "Secondary",
		ASWL_SELECT_ALL: "Select all",
		ASWL_SORTING: "Sorting",
		ASWL_STALE_DATA_MESSAGE: "One of the selected encounters have been updated since opening the current session. It cannot be saved until the data has been refreshed. Reload the assignment worklist to view the updates and continue modifications.",
		ASWL_UNASSIGN: "Unassign",
		ASWL_UNASSIGNED: "Unassigned",
		ASWL_UNASSIGN_ALL_SELECTED:"Unassign All Selected",
		ASWL_UNASSIGN_RELATIONSHIPS: "Unassign Relationships",
		ASWL_VALUE_ALL: "ALL",
		ASWL_VALUE_ASSIGNED: "ASSIGNED",
		ASWL_VALUE_UNASSIGNED: "UNASSIGNED"
    };
}();/**
 * @author RM023573
