...
}i18n.discernabu.covc_o1={ADD_NEW_VIEW:"Add New View",ALL_UNSAVED_DATA:"All unsaved data will be lost.",ALIAS_CONFIG:"Alias Configuration",ALIAS_VALIDATION_FAIL:'An invalid character has been entered.  The system does not accept the following characters for aliasing: ^, ~, ", or \\',ALLOWED_CHARS:"Only letters, numbers, spaces, and underscores.",AVAIL_FOLDERS:"Available Folders",BLANK_VIEW:"View name can't be blank.",COLOR_BROWN:"Brown",COLOR_DEFAULT:"Default",COLOR_GREEN:"Green",COLOR_GREY:"Grey",COLOR_LOWLIGHT:"Lowlight",COLOR_MAROON:"Maroon",COLOR_ORANGE:"Orange",COLOR_PINK:"Pink",COLOR_PURPLE:"Purple",COLOR_YELLOW:"Yellow",CANCEL_CHANGES:"Cancel",CONFIRM_ADD_VIEW:"Do you really want to add a new view?",CONFIRM_CHANGE_VIEW:"Do you really want to change views?",CONFIRM_REMOVE_VIEW:"You are about to delete the current view.",CONFIGURE_ALIAS:"Order Alias Configuration",CONTACT_ADMIN:"Please contact your administrator",CREATE_TABLE:"Aliasing cannot continue until the CUST_MP_COMMON_ORD_ALIAS table has been created.  Please contact your system administrator.",DEFAULT:"Default",DELETE_CURRENT_VIEW:"Delete Current View",DUPLICATE_VIEW_MESSAGE:"The selected name is a duplicate of an existing view.",ERROR:"Error",ERROR_SAVING:"Error saving user preferences",ERROR_RETRIEVING:"Error retrieving user preferences",FAILED_VALIDATION:"Validation Failed",GET_VIEW_TO_ADD:"View Name",GET_RENAME_VIEW:"Please enter a new name for the current view called {name}.",MENU_COLOR_HOVER:"Select colour",MNEMONIC:"Mnemonic",MNEMONIC_ALIAS:"Mnemonic Alias",NO_RESULTS_FOUND:"No results found",PLEASE_TRY_AGAIN:"Please try again.",PROCEED:"Would you like to proceed?",QUICK_ORDERS_CUST_TITLE:"Quick Orders and Charges Configuration",REENTER_VIEW:"Please reenter the view name using only letters, numbers, spaces or underscores.",RENAME_VIEW:"Rename View",RENAME_VIEW_SUCCESS:"Successfully Renamed View",SAVE_VIEW:"Save",SAVE_ALIAS:"Save",SAVED_SUCCESSFULLY:"Saved Successfully",SELECTED_FOLDERS:"Selected Folders",SELECTED_VIEW:"Selected View",SENTENCE:"Sentence",SENTENCE_ALIAS:"Sentence Alias",SIGN:"Sign",SPECIAL_CHARS:"No special characters allowed.",STATUS:"Status",UNIQUE_VIEW_NAME:"Please enter a unique view name.",UPDATE_VIEW:"Update View",VIEW:"View",VIEW_REMOVED_SUCCESS:"View Removed Successfully"};
