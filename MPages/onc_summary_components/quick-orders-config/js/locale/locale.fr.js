...
}i18n.discernabu.covc_o1={ADD_NEW_VIEW:"Ajouter une nouvelle vue",ALL_UNSAVED_DATA:"Toutes les données non enregistrées seront perdues.",ALIAS_CONFIG:"Configuration des alias",ALIAS_VALIDATION_FAIL:"Un caractère non valide a été saisi. Le système n'autorise pas les caractères suivants pour la création d'alias : ^, ~, \" ou \\",ALLOWED_CHARS:"Utilisez uniquement des lettres, des chiffres, des espaces et des traits de soulignement.",AVAIL_FOLDERS:"Dossiers disponibles",BLANK_VIEW:"Le nom de la vue ne peut pas être vide.",COLOR_BROWN:"Brun",COLOR_DEFAULT:"Valeur par défaut",COLOR_GREEN:"Vert",COLOR_GREY:"Gris",COLOR_LOWLIGHT:"Clair",COLOR_MAROON:"Bordeaux",COLOR_ORANGE:"Orange",COLOR_PINK:"Rose",COLOR_PURPLE:"Violet",COLOR_YELLOW:"Jaune",CANCEL_CHANGES:"Annuler",CONFIRM_ADD_VIEW:"Voulez-vous vraiment ajouter une nouvelle vue ?",CONFIRM_CHANGE_VIEW:"Voulez-vous vraiment changer les vues ?",CONFIRM_REMOVE_VIEW:"Vous êtes sur le point de supprimer la vue actuelle.",CONFIGURE_ALIAS:"Configuration des alias de prescription",CONTACT_ADMIN:"Veuillez contacter l'administrateur.",CREATE_TABLE:"Il est impossible de poursuivre la création d'alias tant que la table CUST_MP_COMMON_ORD_ALIAS n'a pas été créée.  Veuillez contacter l'administrateur système.",DEFAULT:"Valeur par défaut",DELETE_CURRENT_VIEW:"Supprimer la vue actuelle",DUPLICATE_VIEW_MESSAGE:"Le nom sélectionné est un doublon d'une vue existante.",ERROR:"Erreur",ERROR_SAVING:"Erreur d'enregistrement des préférences utilisateur",ERROR_RETRIEVING:"Erreur de récupération des préférences utilisateur",FAILED_VALIDATION:"Échec de la validation",GET_VIEW_TO_ADD:"Nom de la vue",GET_RENAME_VIEW:"Veuillez saisir un nouveau nom pour la vue actuelle intitulée {nom}.",MENU_COLOR_HOVER:"Sélectionner une couleur",MNEMONIC:"Mnémonique",MNEMONIC_ALIAS:"Alias de mnémonique",NO_RESULTS_FOUND:"Aucun résultat n'a été trouvé.",PLEASE_TRY_AGAIN:"Veuillez ressayer.",PROCEED:"Voulez-vous poursuivre ?",QUICK_ORDERS_CUST_TITLE:"Configuration des frais et de la fenêtre de saisie rapide",REENTER_VIEW:"Veuillez saisir à nouveau le nom de la vue en utilisant uniquement des lettres, des chiffres, des espaces et des traits de soulignement.",RENAME_VIEW:"Renommer la vue",RENAME_VIEW_SUCCESS:"Vue renommée",SAVE_VIEW:"Enregistrer",SAVE_ALIAS:"Enregistrer",SAVED_SUCCESSFULLY:"Enregistrement réussi",SELECTED_FOLDERS:"Dossiers sélectionnés",SELECTED_VIEW:"Vue sélectionnée",SENTENCE:"Phrase",SENTENCE_ALIAS:"Alias de phrase",SIGN:"Signer",SPECIAL_CHARS:"Les caractères spéciaux ne sont pas autorisés.",STATUS:"Statut",UNIQUE_VIEW_NAME:"Veuillez saisir un nom de vue unique.",UPDATE_VIEW:"Mettre à jour la vue",VIEW:"Vue",VIEW_REMOVED_SUCCESS:"Vue supprimée"};
