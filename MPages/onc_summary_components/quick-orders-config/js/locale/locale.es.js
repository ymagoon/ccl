...
}i18n.discernabu.covc_o1={ADD_NEW_VIEW:"Agregar nueva vista",ALL_UNSAVED_DATA:"Se perderán todos los datos no guardados.",ALIAS_CONFIG:"Configuración de alias",ALIAS_VALIDATION_FAIL:'Se ha escrito un caracter no válido.  El sistema no acepta los siguientes caracteres para la asignación de alias: ^, ~, ", o \\',ALLOWED_CHARS:"Solo letras, números, espacios y guiones bajos.",AVAIL_FOLDERS:"Carpetas disponibles",BLANK_VIEW:"El nombre de vista no puede estar vacío.",COLOR_BROWN:"Marrón",COLOR_DEFAULT:"Predeterminado",COLOR_GREEN:"Verde",COLOR_GREY:"Gris",COLOR_LOWLIGHT:"Luz baja",COLOR_MAROON:"Granate",COLOR_ORANGE:"Naranja",COLOR_PINK:"Rosa",COLOR_PURPLE:"Morado",COLOR_YELLOW:"Amarillo",CANCEL_CHANGES:"Cancelar",CONFIRM_ADD_VIEW:"¿Realmente desea agregar una nueva vista?",CONFIRM_CHANGE_VIEW:"¿Realmente desea cambiar de vista?",CONFIRM_REMOVE_VIEW:"Está a punto de eliminar la vista actual.",CONFIGURE_ALIAS:"Configuración de alias de indicación",CONTACT_ADMIN:"Contáctese con el administrador",CREATE_TABLE:"No se puede continuar con la asignación de alias hasta que se haya creado la tabla CUST_MP_COMMON_ORD_ALIAS.  Póngase en contacto con el administrador del sistema.",DEFAULT:"Predeterminado",DELETE_CURRENT_VIEW:"Eliminar vista actual",DUPLICATE_VIEW_MESSAGE:"El nombre seleccionado es un duplicado de una vista existente.",ERROR:"Error",ERROR_SAVING:"Error al guardar preferencias de usuario",ERROR_RETRIEVING:"Error al recuperar preferencias de usuario",FAILED_VALIDATION:"Error de validación",GET_VIEW_TO_ADD:"Ver nombre",GET_RENAME_VIEW:"Escriba un nombre nuevo para la vista actual llamada {name}.",MENU_COLOR_HOVER:"Seleccionar color",MNEMONIC:"Mnemotécnica",MNEMONIC_ALIAS:"Alias mnemotécnico",NO_RESULTS_FOUND:"No se encuentran resultados",PLEASE_TRY_AGAIN:"Inténtelo de nuevo.",PROCEED:"¿Desea proceder?",QUICK_ORDERS_CUST_TITLE:"Configuración de indicaciones rápidas y cargos",REENTER_VIEW:"Vuelva a escribir el nombre de vista usando solo letras, números, espacios o guiones bajos.",RENAME_VIEW:"Renombrar vista",RENAME_VIEW_SUCCESS:"Vista renombrada correctamente",SAVE_VIEW:"Guardar",SAVE_ALIAS:"Guardar",SAVED_SUCCESSFULLY:"Guardado correctamente",SELECTED_FOLDERS:"Carpetas seleccionadas",SELECTED_VIEW:"Vistas seleccionadas",SENTENCE:"Frase",SENTENCE_ALIAS:"Alias de frase",SIGN:"Firmar",SPECIAL_CHARS:"No se permiten caracteres especiales.",STATUS:"Estado",UNIQUE_VIEW_NAME:"Escriba un nombre de vista único.",UPDATE_VIEW:"Actualizar vista",VIEW:"Ver",VIEW_REMOVED_SUCCESS:"La vista se quitó correctamente"};
