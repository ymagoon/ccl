...
﻿CKEDITOR.plugins.setLang( 'cernhover', 'en',
{
...
CKEDITOR.plugins.setLang('cernautotext', 'en',
{
...
﻿
CKEDITOR.plugins.setLang('cernscayt', 'en',
{
	noSpellingSuggestions: '(No Suggestions)'
});

﻿CKEDITOR.plugins.setLang('cernf3', 'en',
{
...
﻿CKEDITOR.plugins.setLang('mpagesf3', 'en',
{
	//Use this array to change Hot key assignments.  Do not change the second element in the inner arrays (the command name, example 'ddcut' and 'ddcopy' should not be changed)
	HotKeyArray:
	[
...
For licensing, see LICENSE.html or http://ckeditor.com/license
*/
CKEDITOR.plugins.setLang( 'cerndyndocjustify', 'en', {
	block: 'Justify',
	center: 'Center',
	left: 'Align Left',
	right: 'Align Right'
