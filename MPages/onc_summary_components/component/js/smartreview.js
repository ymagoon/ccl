...
}else{if(clarification.ACTION_FLAG==2){secHTMLArray.push(CERN_DQR_O1.SetImageAndLabelHover(component,identifier,clarSequence,"skipped","dqr-skipped",i18n.discernabu.smartreview_o1.SKIPPED,sectionCount));
...
}if(clarification.SUPPORTING_DATA.LAB_VITALS.length!=0){html.push(CERN_DQR_O1.AddFindings(i18n.discernabu.smartreview_o1.LABS,clarification.SUPPORTING_DATA.LAB_VITALS));
}html.push("</div>");
...
for(var i=0;
i<findings.length;
i++){html.push('<li class="dqr-table-findings-SupportingFindings-entry-div">',CERN_DQR_O1.ReplaceInvalidStringCharacters(findings[i].DISPLAY),"</li>");
}html.push("</div>");
return html.join("");
