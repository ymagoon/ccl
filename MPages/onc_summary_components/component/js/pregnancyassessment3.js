  ...
  * @class
  */
function PregAssessment3Style() {
	this.initByNamespace("pa3");
}

PregAssessment3Style.inherits(ComponentStyle);

function PregAssessment3Component(criterion) {
	...
	PregAssessment3Component.method("InsertData", function() {
		CERN_PREG_ASSESSMENT3_O1.GetPregAssessment3Data(this);
	});
	PregAssessment3Component.method("HandleSuccess", function(recordData) {
		CERN_PREG_ASSESSMENT_BASE_O1.RenderAssessmentSection(this, recordData, 3);
	});
	PregAssessment3Component.method("RetrieveRequiredResources", function() {
	...
	PregAssessment3Component.method("setAntepartumNote3", function(value) {
		this.m_antepartumNote3 = value;
	});
	PregAssessment3Component.method("getAntepartumNote3", function() {
		return this.m_antepartumNote3;
	});
...
/**
 * Preg Assessment 3 methods
 * @namespace
 */
var CERN_PREG_ASSESSMENT3_O1 = function() {
	...
	function updateComponentMenu(component) {
		...
		component.addMenuOption("laborGraph" + compId, "laborGraph" + compId, pai18n.LABOR_GRAPH, false, "click", function() {
			...
			try{
				...
				MP_Util.LogJSError(discernErr, this, "pregnancyassessment3-o1.js", "menuItemOnClickHandler");
				return;
			}
		});
	...
	return {
		GetPregAssessment3Data : function(component) {
			var sendAr = [];
			var criterion = component.getCriterion();
			var messageHTML = "";
			var pai18n = i18n.discernabu.pregassessmentbase;
			...
			if(criterion.getPatientInfo().getSex().meaning !== "FEMALE") {
				...
				if(pregnancyId === -1) {
					...
					sendAr.push("^MINE^", criterion.person_id + ".0", criterion.provider_id + ".0", criterion.position_cd + ".0", criterion.ppr_cd + ".0", pregInfoObj.getLookBack(), "3");
