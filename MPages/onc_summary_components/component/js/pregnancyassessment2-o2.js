function PregAssessment2StyleWF() {
	this.initByNamespace("pa2-wf");
}

PregAssessment2StyleWF.inherits(ComponentStyle);

/**
 * The Pregnancy Secondary Assessment component retrieves the results documented for a patient
 ...
 */
function PregAssessment2ComponentWF(criterion) {
	...
	// Constant to represent the Secondary Component
...
/**
 * Map the Secondary Assessment option 2 object to the bedrock filter mapping so the
 ...
 */
PregAssessment2ComponentWF.prototype.preProcessing = function() {
 ...
 */
PregAssessment2ComponentWF.prototype.menuItemOnClickHandler = function(clickEvent) {
	var criterion = this.getCriterion();
	var pai18n = i18n.discernabu.pregassessmentbase_o2;
	...
	try {
		...
		MP_Util.LogJSError(discernErr, this, "pregnancyassessment2-o2.js", "menuItemOnClickHandler");
		return;
	}
...
/**
 * Removes menu options for Secondary Assessment component and it will
 * be called if pregnacyId is null/0/-1 from retrieveComponentData() method
 */
PregAssessment2ComponentWF.prototype.removeMenuOptions = function() {
 ...
 */
PregAssessment2ComponentWF.prototype.RetrieveRequiredResources = function() {
	var pregInfoObj = null;
 ...
 * the necessary script call to retrieve the Secondary Assessment data.
 */
PregAssessment2ComponentWF.prototype.retrieveComponentData = function() {
	var sendAr = [];
	var criterion = this.getCriterion();
	var encntrOption=0;
	var messageHTML = "";
...
/**
 * Renders the Secondary Assessment component by calling the Assessment Base component.
 *
 * @param recordData -
 *            has the information retrieved from the Secondary Assessment script call.
 */
PregAssessment2ComponentWF.prototype.renderComponent = function(recordData) {
	var criterion = this.getCriterion();
