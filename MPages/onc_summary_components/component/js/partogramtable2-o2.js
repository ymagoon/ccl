function PartoTable2StyleWF() {
    this.initByNamespace("parto-table2-wf");
}

PartoTable2StyleWF.inherits(ComponentStyle);

/**
 * The Partogram Table2 component retrieves the results documented for a patient for various assessments.
 * 
 * @param {criterion}
 *            criterion : The Criterion object which contains information needed to render the component.
 */
function PartoTable2ComponentWF(criterion) {
 ...
 */
PartoTable2ComponentWF.prototype.retrieveComponentData = function() {
 ...
 */
PartoTable2ComponentWF.prototype.getImageFolderPath = function() {
    return this.imageFolderPath;
};

/**
 * Renders the Partogram Table2 component by calling the Table Base component.
 * 
 * @param recordData-
 *            has the information retrieved from the Partogram Table script call.
 */
PartoTable2ComponentWF.prototype.renderComponent = function(recordData) {
 ...
 */
PartoTable2ComponentWF.prototype.postProcessing = function() {
...
PartoTable2ComponentWF.prototype.resizeComponent = function() {
    if (this.recordData != null && this.recordData.STATUS_DATA.STATUS === "S") {
 ...
 */
PartoTable2ComponentWF.prototype.RetrieveRequiredResources = function() {
 ...
 * 
 */
PartoTable2ComponentWF.prototype.postDOMLocationChange = function() {
    if (this.recordData != null && this.recordData.STATUS_DATA.STATUS === "S") {
