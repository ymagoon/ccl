...
episodeStartDateValue=dateFormat(episodeStartDate,dateFormat.masks.longDate);
episodeStartTimeValue=dateFormat(episodeStartDate,dateFormat.masks.shortTime);
episodeStopDate.setISO8601(episode.COMPLETE_DT_TM);
episodeStopDateValue=dateFormat(episodeStopDate,dateFormat.masks.longDate);
episodeStopTimeValue=dateFormat(episodeStopDate,dateFormat.masks.shortTime);
