...
if(strOtherSplit.length>0){if(strOtherSplit.length>2&&strOtherSplit[2]==1){arHTML.push("<a onclick='CustomLinksComponent.prototype.loadCclNewSessionWindow(\"",strOtherSplit[0],'","',strOtherSplit[1],'","1")\''," title='"+cl_i18n.TITLE_PMP+"' class='cl-link-text'>");
