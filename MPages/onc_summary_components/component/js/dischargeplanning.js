...
function DischargePlanningComponent(criterion) {
	...
	DischargePlanningComponent.method("setDurableMedEquipment",
			function(value) {
    ...
    return {
        ...
        RenderComponent: function(component, recordData){
			...
			try{
				...
				if (recordData.FIN_CLASS == "MEDICARE") {
					jsHTML.push("<dl class='cm-info'><dt><span class='row-label'>", i18n.MIM_SIGNED, ":</span></dt><dd class='cm-detail'><span>", admitMimSignedDtTm, "</span></dd></dl>");				
