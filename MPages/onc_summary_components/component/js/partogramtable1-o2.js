function PartoTable1StyleWF() {
    this.initByNamespace("parto-table1-wf");
}

PartoTable1StyleWF.inherits(ComponentStyle);

/**
 * The Partogram Table1 component retrieves the results documented for a patient for various assessments.
 * 
 * @param {criterion}
 *            criterion : The Criterion object which contains information needed to render the component.
 */
function PartoTable1ComponentWF(criterion) {
 ...
 */
PartoTable1ComponentWF.prototype.retrieveComponentData = function() {
 ...
 */
PartoTable1ComponentWF.prototype.getImageFolderPath = function() {
    return this.imageFolderPath;
};

/**
 * Renders the Partogram Table1 component by calling the Table Base component.
 * 
 * @param recordData -
 *            has the information retrieved from the Partogram Table script call.
 */
PartoTable1ComponentWF.prototype.renderComponent = function(recordData) {
 ...
 */
PartoTable1ComponentWF.prototype.postProcessing = function() {
...
PartoTable1ComponentWF.prototype.resizeComponent = function() {
    if (this.recordData != null && this.recordData.STATUS_DATA.STATUS === "S") {
 ...
 */
PartoTable1ComponentWF.prototype.RetrieveRequiredResources = function() {
 ...
 * 
 */
PartoTable1ComponentWF.prototype.postDOMLocationChange = function() {
    if (this.recordData != null && this.recordData.STATUS_DATA.STATUS === "S") {
