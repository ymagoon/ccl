    ...
    app: {
        modules: {
            ...
            patientPopulation: {
                ...
                NURSE_UNIT_TITLE: "Nurse Units",
                NURSE_UNIT_LABEL: "Nurse Units",
                NURSE_UNIT_CAPTION: "Click to open Nurse Units.",
                NURSE_UNIT_DIALOG_TITLE: "Please select one or more nurse units.",
                SUBMIT_CAPTION: "Submit",
                CANCEL_CAPTION: "Cancel",
                FACILITES_LOAD_FAILED: "Unable to load Facilities",
                NURSE_UNITS_LOAD_FAILED: "Unable to load available Nurse Units",
                ...
                PL_FACILITIES_TOOLTIP: "In order to display list of qualifying patients, select either a Patient List or a Facility and Nurse unit from the selections above and click the Submit button.",
                FACILITIES_NU_TOOLTIP: "In order to display list of qualifying patients, select a Facility and Nurse unit from the selections above and click the Submit button.",
            ...
            logMessage: {
                ...
                NURSE_UNIT_LIST_FAILED: "Unable to build list of selected nurse units",
