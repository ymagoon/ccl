...
i18n.discernabu.onc_staging={
	CANCEL:"Annuler",
	CANCEL_CONFIRM:"Des modifications non enregistrées existent, souhaitez-vous continuer ?",
	CLINICAL_STAGE:"Groupement des stades cliniques :",
	DATE_OF_BIRTH:"Né(e) le : ",
	DISTANT_METASTASIS:"Métastases à distance (M) :",
	FIN:"Numéro de séjour :  ",
	FORM:"Formulaire :",
	MONTHS:["JAN","FÉV","MAR","AVR","MAI","JUI","JUI","AOÛ","SEP","OCT","NOV","DÉC"],
	NO:"Non",
	ONC_ERROR:"Une erreur s'est produite dans la stadification de cancérologie :",
	ONSET_ALERT:"La date de début ne peut pas être située dans le futur.",
	ONSET_DATE:"*Date de début :",
	PRIMARY_TUMOR:"Tumeur primitive (T) :",
	PROBLEM:"Problème :",
	REGIONAL_LYMPH:"Ganglions lymphatiques régionaux (N) :",
	SAVE:"Enregistrer",
	SIGN:"Signer",
	STAGING_SYSTEM:"Système de stadification :"	,
...
i18n.ADVANCE_DIRECTIVE="Directive anticipée";
...
i18n.OTHER="Autre";
i18n.OTHER_DIAGNOSTICS="Autres diagnostics";
...
i18n.RESUSITATION_STATUS="Statut de réanimation";
...
i18n.discernabu.MONTHNAMES=["Jan","Fév","Mar","Avr","Mai","Jun","juillet","Aoû","Sep","Oct","Nov","Déc","Janvier","Février","Mars","Avril","Mai","Juin","Juillet","Août","Septembre","Octobre","Novembre","Décembre"];
