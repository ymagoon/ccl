    ...
    for (var i = 1; i <= graphCount; i++) {
        ...
        $('#flotTable' + i).each(function(){
            ...
            if ($(this).hasClass('bpTable')) {
                tableMin -= (tableRange * .1);
                tableMax += (tableRange * .3);
                $(this).graphTable({
                    graphNum: i,
                    series: 'columns',
                    width: '50em',
        ...
        $(".flot-graph").bind("plothover", function(event, pos, item){
            ...
            if (item) {
                if (previousPoint != item.datapoint) {
                    ...
                    ar.push("<div class='hvr'><dl><dt><span>", displayEvent, ":</span></dt><dd><span class='", normalcy, "'>", nf.format(y, "."+yPrec), " " + graphDetails.UNITS, "</span></dd><br/><dt><span>",graphi18n.RESULT_DT_TM ,":</span></dt><dd><span>", dateTime, "</span></dd>");
