...
**************************************************************************
          ...
          Source file name:   vigilanz_get_procedures
          Object name:        vigilanz_get_procedures
 ...
 ***********************************************************************
  ...
  015 04/10/19 RJC					Fixed issue with default encounter list being set
 ***********************************************************************/
drop program vigilanz_get_procedures go
create program vigilanz_get_procedures
