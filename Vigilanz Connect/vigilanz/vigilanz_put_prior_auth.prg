...
**********************************************************************
      Source file name: snsro_put_prior_auth.prg
      Object name:      vigilanz_put_prior_auth
      Program purpose:  Updates a prior authorization in millennium
...
----------------------------------------------------------------------
  ...
  003	02/27/20	RJC			Complete rewrite. New fields added
***********************************************************************/
drop program vigilanz_put_prior_auth go
create program vigilanz_put_prior_auth
...
if(iDebugFlag > 0)
	...
	set _file = build2(trim(file_path),"/snsro_put_prior_auth.json")
