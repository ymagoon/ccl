...
**********************************************************************
      Source file name: snsro_put_enc_reltn.prg
      Object name:      vigilanz_put_enc_reltn
...
----------------------------------------------------------------------
  ...
  002 01/15/20 RJC		Added update_reltn_ind
...
***********************************************************************/
drop program vigilanz_put_enc_reltn go
create program vigilanz_put_enc_reltn
...
record arglist (
	...
	1 relatedPersonRelationToPatientId	= vc	;Required
	1 patientRelationToRelatedPersonId	= vc	;Optional
)
...
; Constants
declare c_error_handler						= vc with protect, constant("PUT ENCOUNTER RELATION")
...
set input->patient_reltn_2_related_person_cd =
	cnvtreal(arglist->patientRelationToRelatedPersonId)
set input->related_person_reltn_2_patient_cd =
	cnvtreal(arglist->relatedPersonRelationToPatientId)
