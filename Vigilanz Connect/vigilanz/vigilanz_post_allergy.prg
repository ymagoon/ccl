...
************************************************************************************
      ...
      Object name:          vigilanz_post_allergy
...
************************************************************************************
 ...
 006 06/04/19 RJC					Minor bug fixes
************************************************************************************/
drop program vigilanz_post_allergy go
create program vigilanz_post_allergy
	 	...
	 	while (str != notfnd)
	     	...
	     	if(str != notfnd)
				...
				where nomenclature_id = reactions_req->reactions[num]->reaction_cd
	     		...
	     		if (curqual = 0)
	     			call ErrorHandler2("EXECUTE", "F", "POST ALLERGY", build("Invalid Reaction Code: ",trim(str,3)),
	     			"2088", build("Invalid Reaction Code: ",trim(str,3)), allergy_reply_out)
					go to exit_script
				endif
	        endif
	      	set num = num + 1
