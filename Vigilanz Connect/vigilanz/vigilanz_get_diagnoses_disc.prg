/*~BB~*************************************************************************************
  ...
  ~BE~**************************************************************************************
      Source file name: snsro_get_diagnoses_disc.prg
      Object name:      vigilanz_get_diagnoses_disc
...
drop program vigilanz_get_diagnoses_disc go
create program vigilanz_get_diagnoses_disc
