drop program avh_cust_banner_bar go
create program avh_cust_banner_bar
...
;add logic to support running from CCL
...
foot report
  pt->allergies = replace(pt->allergies,",","",2) ;replace last comma
with nocounter
...
;  and ce.contributor_system_cd = 469 ;powerchart
