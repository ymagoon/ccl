...
<xsl:stylesheet version="2.0" xmlns:xsl="http://www.w3.org/1999/XSL/Transform"
	...
	<xsl:variable name="ContactForPendingResults" as="xs:string" select="'Binnen 72 uur ontvangt u de resultaten.'"/>
	...
	<xsl:variable name="laboratoryCatalogMeaning" as="xs:string" select="'ALGEMEEN LAB'"/>
	<xsl:variable name="radiologyCatalogMeaning" as="xs:string" select="'RADIOLOGIE'"/>
