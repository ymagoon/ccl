...
<xsl:stylesheet version="2.0" 
	...
	<xsl:variable name="ImplantedThisVisitTitle" as="xs:string" select="'Implantaat dit bezoek'"/>
	<xsl:variable name="ExplantedThisVisitTitle" as="xs:string" select="'Verwijderd tijdens dit bezoek'"/>
	<xsl:variable name="MRUnsafeAlert" as="xs:string" select="'Opmerking: Deze pati&#235;nt heeft implantaten gekregen bij dit bezoek die niet MRI-compatibel zijn.'"/>
	<xsl:variable name="MRPossiblyUnsafeAlert" as="xs:string" select="'Opmerking: Deze pati&#235;nt heeft implantaten gekregen bij dit bezoek die mogelijk niet MRI-compatibel zijn.'"/>
