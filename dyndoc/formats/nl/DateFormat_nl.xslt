...
<xsl:stylesheet version="2.0" xmlns:xsl="http://www.w3.org/1999/XSL/Transform"
	...
	<xsl:variable name="DATE_SEQUENCE_UTC_ON" as="xs:string" select="'d/MM/yyyy HH:mm zzz'"/>
	<xsl:variable name="DATE_SEQUENCE_UTC_OFF" as="xs:string" select="'d/MM/yyyy HH:mm'"/>
	<xsl:variable name="DATE_ONLY_SEQUENCE" as="xs:string" select="'d/MM/yyyy'"/>
	<xsl:variable name="DATE_SEQUENCE_UTC_ON_WITH_TIME" as="xs:string" select="'d/MM/yyyy hh:mm a zzz'"/>
	<xsl:variable name="DATE_SEQUENCE_UTC_ON_WITHOUT_TIME" as="xs:string" select="'d/MM/yyyy zzz'"/>
	<xsl:variable name="DATE_SEQUENCE_UTC_OFF_WITH_TIME" as="xs:string" select="'d/MM/yyyy hh:mm a'"/>
