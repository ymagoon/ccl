...
<xsl:stylesheet version="2.0" xmlns:xsl="http://www.w3.org/1999/XSL/Transform"
	...
	<xsl:variable name="NoMeds" as="xs:string">
		<xsl:value-of select="'No hay medicaci&#243;n activa.'"/>
	</xsl:variable>
	<xsl:variable name="NoInpatientMeds" as="xs:string">
		<xsl:value-of select="'No hay medicaci&#243;n de paciente interno activa'"/>
	</xsl:variable>
	<xsl:variable name="NoHomeMeds" as="xs:string">
		<xsl:value-of select="'No hay medicaci&#243;n domiciliaria activa'"/>
	</xsl:variable>
	<xsl:variable name="sCatTitleInpatient" as="xs:string">
		<xsl:value-of select="'Paciente interno'"/>
	</xsl:variable>
