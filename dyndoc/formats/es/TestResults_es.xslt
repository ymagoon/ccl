...
<xsl:stylesheet version="2.0" xmlns:xsl="http://www.w3.org/1999/XSL/Transform"
	...
	<xsl:variable name="ResultsPending" as="xs:string">
		<strong>
			<xsl:value-of select="'-- Resultados pendientes --'"/>
		</strong>
	</xsl:variable>
	<xsl:variable name="ContactForPendingResults" as="xs:string" select="'Nos pondremos en contacto con usted en 72 horas para darle los resultados.'"/>
