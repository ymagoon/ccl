...
<xsl:stylesheet version="2.0" 
	...
	<xsl:variable name="ImplantedThisVisitTitle" as="xs:string" select="'Implantados'"/>
	<xsl:variable name="ExplantedThisVisitTitle" as="xs:string" select="'Retirados'"/>
	<xsl:variable name="MRUnsafeAlert" as="xs:string" select="'Aviso: durante esta visita se le han implantado dispositivos que pueden no ser compatibles con la RM.'"/>
	<xsl:variable name="MRPossiblyUnsafeAlert" as="xs:string" select="'Aviso: durante esta visita se le han implantado dispositivos que pueden no ser compatibles con la RM.'"/>
