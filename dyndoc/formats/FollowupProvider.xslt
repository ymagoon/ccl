...
<xsl:stylesheet version="2.0" xmlns:xsl="http://www.w3.org/1999/XSL/Transform"
	...
	<xsl:variable name="NoFollowup" as="xs:string">
		<xsl:value-of select="'No qualifying data available'"/>
	</xsl:variable>
					...
					<tbody>
						<xsl:for-each select="n:report/n:clinical-data/n:follow-up-data/n:follow-up">
							...
							<tr class="ddemrcontentitem ddremovable" style="border-top: 1px solid #000" dd:btnfloatingstyle="top-right">
								...
								<td colspan="3">
									<table style="width:100%; border-collapse:collapse; border-spacing:0;" dd:whitespacecolseparator="true"> <!-- Separate columns by a space in plain text conversion -->
										...
										<tr class="ddgrouper ddremovable" dd:btnfloatingstyle="top-right">
											<td colspan="3" style="border-top:1px solid #000; padding:3px;">
												<xsl:choose>
													...
													<xsl:otherwise>
														<table style="width:100%; border:0;" dd:whitespacecolseparator="true"> <!-- Separate columns by a space in plain text conversion -->
															<colgroup>
																<col style="width:1%;" />
																<col style="width:99%;" />
															</colgroup>
