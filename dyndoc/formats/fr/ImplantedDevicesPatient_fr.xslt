...
<xsl:stylesheet version="2.0" 
	...
	<xsl:variable name="ImplantedThisVisitTitle" as="xs:string" select="'Implant&#233;(s)'"/>
	<xsl:variable name="ExplantedThisVisitTitle" as="xs:string" select="'Supprim&#233;(s)'"/>
	<xsl:variable name="MRUnsafeAlert" as="xs:string" select="'Remarque : les dispositifs implant&#233;s pendant ce s&#233;jour peuvent &#234;tre incompatibles avec un examen IRM.'"/>
	<xsl:variable name="MRPossiblyUnsafeAlert" as="xs:string" select="'Remarque : les dispositifs implant&#233;s pendant ce s&#233;jour peuvent &#234;tre incompatibles avec un examen IRM.'"/>
