...
<xsl:stylesheet version="2.0" xmlns:xsl="http://www.w3.org/1999/XSL/Transform"
	...
	<xsl:variable name="OngoingProblems" as="xs:string">
		<xsl:value-of select="'En cours - '"/>
	</xsl:variable>

	<xsl:variable name="HistoricalProblems" as="xs:string">
		<xsl:value-of select="'Ant&#233;c&#233;dents - '"/>
	</xsl:variable>
	
	<xsl:variable name="OngoingDescription" as="xs:string">
		<xsl:value-of select="'Tout probl&#232;me pour lequel vous recevez actuellement un traitement.'"/>
	</xsl:variable>
	
	<xsl:variable name="HistoricalDescription" as="xs:string">
		<xsl:value-of select="'Tout probl&#232;me pour lequel vous ne recevez plus de traitement.'"/>
	</xsl:variable>

	<xsl:variable name="NoChronicProblems" as="xs:string">
		<xsl:value-of select="'Aucun probl&#232;me chronique'"/>
	</xsl:variable>
