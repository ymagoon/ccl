...
<xsl:stylesheet version="2.0" xmlns:xsl="http://www.w3.org/1999/XSL/Transform"
	...
	<xsl:variable name="ResultsPending" as="xs:string">
		<strong>
			<xsl:value-of select="'-- R&#233;sultats en attente --'"/>
		</strong>
	</xsl:variable>
	<xsl:variable name="ContactForPendingResults" as="xs:string" select="'Vous serez contacté d&#8217;ici 72 heures au sujet de vos résultats.'"/>
