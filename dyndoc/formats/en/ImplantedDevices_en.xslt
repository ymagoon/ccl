...
<xsl:stylesheet version="2.0" 
	...
	<xsl:variable name="ImplantedThisVisitTitle" as="xs:string" select="'Implanted This Visit'"/>
	<xsl:variable name="ExplantedThisVisitTitle" as="xs:string" select="'Removed This Visit'"/>
	<xsl:variable name="MRUnsafeAlert" as="xs:string" select="'Notice: This patient has devices implanted this visit that are not MRI compatible.'"/>
	<xsl:variable name="MRPossiblyUnsafeAlert" as="xs:string" select="'Notice: This patient has devices implanted this visit that may not be MR compatible.'"/>
