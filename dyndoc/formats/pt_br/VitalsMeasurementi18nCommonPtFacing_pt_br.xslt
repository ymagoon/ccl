...
<xsl:stylesheet version="2.0" xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:xs="http://www.w3.org/2001/XMLSchema">
	...
	<xsl:variable name="sAbbrvHeartRate" as="xs:string"><xsl:value-of select="'Frequ&#234;ncia card&#237;aca'"/></xsl:variable>
	<xsl:variable name="sAbbrvRespiratoryRate" as="xs:string"><xsl:value-of select="'Frequ&#234;ncia respirat&#243;ria'"/></xsl:variable>
	<xsl:variable name="sAbbrvBloodPressure" as="xs:string"><xsl:value-of select="'Press&#227;o arterial'"/></xsl:variable>
