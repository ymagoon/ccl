...
<xsl:stylesheet version="2.0" 
	...
	<xsl:variable name="ImplantedThisVisitTitle" as="xs:string" select="'Implantado nesta consulta'"/>
	<xsl:variable name="ExplantedThisVisitTitle" as="xs:string" select="'Removido nesta consulta'"/>
	<xsl:variable name="MRUnsafeAlert" as="xs:string" select="'Aviso: o paciente tem dispositivos implantados, talvez n&#227;o seja possível realizar resson&#226;ncias magn&#233;ticas nesta consulta.'"/>
	<xsl:variable name="MRPossiblyUnsafeAlert" as="xs:string" select="'Aviso: o paciente tem dispositivos implantados, talvez n&#227;o seja possível realizar resson&#226;ncias magn&#233;ticas nesta consulta.'"/>
