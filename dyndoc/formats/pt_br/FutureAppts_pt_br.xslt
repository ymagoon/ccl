...
<xsl:stylesheet version="2.0" xmlns:xsl="http://www.w3.org/1999/XSL/Transform"
    ...
    <!-- Comment out this line to debug--> <xsl:include href="/cernerbasiccontent/formats/pt_br/addressfxn_pt_br.xslt"/>
    <!-- Uncomment this line to debug <xsl:include href="AddressFxn_pt_br.xslt"/> -->
    ...
    <xsl:variable name="Type">
        <xsl:value-of select="'Tipo de agendamento'"/>
    </xsl:variable>
