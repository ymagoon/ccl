...
<xsl:stylesheet version="2.0" xmlns:xsl="http://www.w3.org/1999/XSL/Transform"
	...
	<xsl:variable name="ResultsPending" as="xs:string">
		<strong>
			<xsl:value-of select="'-- Resultados pendentes --'"/>
		</strong>
	</xsl:variable>
	<xsl:variable name="ContactForPendingResults" as="xs:string" select="'Voc&#234; ser&#225; contatado em 72 horas com seus resultados.'"/>
