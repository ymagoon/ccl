...
<xsl:stylesheet version="2.0" 
	...
	<xsl:variable name="ImplantedThisVisitTitle" as="xs:string" select="'Bei diesem Aufenthalt implantiert'"/>
	<xsl:variable name="ExplantedThisVisitTitle" as="xs:string" select="'Bei diesem Aufenthalt entfernt'"/>
	<xsl:variable name="MRUnsafeAlert" as="xs:string" select="'Hinweis: Dem Patienten wurden Implantate implantiert, die evtl. nicht mit MRTs kompatibel sind.'"/>
	<xsl:variable name="MRPossiblyUnsafeAlert" as="xs:string" select="'Hinweis: Dem Patienten wurden Implantate implantiert, die evtl. nicht mit MRTs kompatibel sind.'"/>
