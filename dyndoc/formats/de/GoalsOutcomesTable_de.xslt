...
<xsl:stylesheet version="2.0" xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:xs="http://www.w3.org/2001/XMLSchema" xmlns:fn="http://www.w3.org/2005/xpath-functions" xmlns:n="urn:com-cerner-patient-ehr:v3">
	...
	<xsl:variable name="goalHeading" as="xs:string" select="'Zielbeschreibung'"/>
	<xsl:variable name="isMetHeading" as="xs:string" select="'Erreicht/Nicht erreicht'"/>
	<xsl:variable name="outcomeHeading" as="xs:string" select="'Ergebnis'"/>
