...
<xsl:stylesheet version="2.0" xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:xs="http://www.w3.org/2001/XMLSchema" xmlns:fn="http://www.w3.org/2005/xpath-functions">
    ...
    <xsl:variable name="typeHeading" as="xs:string" select="'Typ'"/>
    <xsl:variable name="diagnosisDateHeading" as="xs:string" select="'Diagnosedatum'"/>
    <xsl:variable name="qualifierHeading" as="xs:string" select="'Kennzeichner'"/>
    <xsl:variable name="clinicalServiceHeading" as="xs:string" select="'Fachabteilung'"/>
