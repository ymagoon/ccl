...
*****************************************************************************/
drop program snsro_get_document go
create program snsro_get_document
		...
		for(i = 1 to compSize)
			if(document_reply_out->master_document.document_components[i].document_handle = "")
				...
				case(document_reply_out->master_document.document_components[i].format)
					of "GIF": 	set encodedBody = base64_encode(docBody)
					of "JPEG": 	set encodedBody = base64_encode(docBody)
					of "MSWORD": set encodedBody = base64_encode(docBody)
					of "PDF": 	set encodedBody = base64_encode(docBody)
					of "PNG": 	set encodedBody = base64_encode(docBody)
					of "PTIFF": set encodedBody = base64_encode(docBody)
					of "TIFF": 	set encodedBody = base64_encode(docBody)
					else
