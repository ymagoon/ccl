...
/*****************************************************************************************
      ...
      Object name:       	snsro_get_referrals
      Program purpose:    	Gets Referral Information
      Tables read:        	NONE
      Tables updated:   	ORDERS, ORDER_DETAIL
 ...
 ***********************************************************************/
/************************************************************************/
drop program snsro_get_referrals go
create program snsro_get_referrals
...
if(dPatientId > 0)
	...
	if(iRet = 0)
	  call ErrorHandler2("GET REFERRALS", "F", "Get Referrals", "No Referrals Found.",
	  "9999",build("No Referrals Found."), referrals_reply_out)
	  go to exit_script
	endif
