...
/*****************************************************************************
          ...
          Object name:        snsro_get_lab_orders
          Request #:          N/A
 ...
 ***********************************************************************/
drop program snsro_get_lab_orders go
create program snsro_get_lab_orders
...
subroutine GetLabOrders(null)
	...
	*****************************************/
	if (dPersonID = 0)
		...
		call ErrorHandler2("EXECUTE", "F", "LAB ORDERS", "Person ID not set - snsro_get_lab_orders",
	...
	*/
	...
	if (oCnt = 0)
		...
		call ErrorHandler("EXECUTE", "Z", "LAB ORDERS", "No records found - snsro_get_lab_orders", laborders_reply_out)
		go to EXIT_SCRIPT
	else
		;set laborders_reply_out->LAB_ORDERS_QUAL = oCnt
		;call echo("Labs found and processed...")
		call ErrorHandler("EXECUTE", "S", "LAB ORDERS",
			"Lab orders successfully processed - snsro_get_lab_orders", laborders_reply_out)
	endif
