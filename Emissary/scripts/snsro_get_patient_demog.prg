...
/*****************************************************************************
          ...
          Source file name:   snsro_get_patient_demog
          Object name:        snsro_get_patient_demog
          Request #:
 ...
 ***********************************************************************/
drop program snsro_get_patient_demog go
create program snsro_get_patient_demog
...
prompt
  "Output to File/Printer/MINE" = "MINE"
	...
	,"User Name:" = ""        		;016
	,"Include Healthplan Info" = 0 ;021
	,"Debug Flag" = 0				;OPTIONAL. Verbose logging when set to one (1).
 
with OUTDEV, PERSON_ID, INC_EXTENDED, INC_CARETEAM, INC_IDENTITY/*006*/,
	INC_PERSON_RELTN/*011*/, USERNAME, INC_HEALTHPLAN_INFO, DEBUG_FLAG   ;022
...
declare dMRN				= f8 with protect, constant(uar_get_code_by("MEANING", 4, "MRN")) /*013*/
...
/*001 End */
  ...
  ;patient_reply_out->mrn = trim(pa.alias,3)	/*013*/  018
...
if( replyCnt > 0)
	for (y = 1 to replyCnt)
		...
		set patient_reply_out->mrn = temp_patient_reply_out->qual[y]->mrn
