...
******************************************************************************************
	...
	Object name: snsro_get_apptdetails
...
******************************************************************************************/
drop program snsro_get_apptdetails go
create program snsro_get_apptdetails
...
if(dOrderFormatId = 0)
	call ErrorHandler2(c_error_handler, "F", "Validate", "Missing required field: AppointmentDetailsId",
	"2055","Missing required field: AppointmentDetailsId", detail_reply_out)
	go to EXIT_SCRIPT
endif
