drop program 1hpg_completed_labs_test go
create program 1hpg_completed_labs_test
...
and CNVTDATETIME(end_dt_tm) and oa.action_type_cd = 2529
...
join a where outerjoin(h.health_plan_id) = a.parent_entity_id
...
and chm.field1_id =  2555298341.00
...
, "|", "Sub2MI","|","Sub2RelToPat","|","ReferringDocNPI","|","ReferringDoc","|","AdmittingDocNPI", "|", "AdmittingDoc"
, "|", "ICD10","|","ICD102", "|", "ServiceCode", "|", "Service Date/Time", "|" )
...
"|",QUAL_INS2_SUBSLNAME,"|",QUAL_INS2_SUBSFNAME,"|",QUAL_INS2_SUBSMNAME,"|", QUAL_INS2_SUBSREL ,"|", QUAL_REF_PHYS_NPI,
"|",QUAL_REF_PHYSICIAN,"|",QUAL_ADM_PHYS_NPI, "|", QUAL_ADM_PHYS,"|",QUAL_DX1,"|",QUAL_DX2,"|",BLIST_BILL_CODE,
"|", BLIST_SVC_DTTM, "|", CHAR(13))
