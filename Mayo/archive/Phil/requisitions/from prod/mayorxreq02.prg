;026 Beg drop program rxreqgen01 go
;create program rxreqgen01
  drop program mayorxreq01:dba go
create program mayorxreq01:dba ;026 End
...
;040            x_pos = k_pos  /*032*/
;040            if (tprint_req->job[d.seq]->sup_phys_dea > " ")
;040                 call print(calcpos(x_pos,y_pos))"DEA #:  ",tprint_req->job[d.seq]->sup_phys_dea
;040            else
...
set script_version = "044 04/15/14 m063907"
set rx_version = "01"
end
go
