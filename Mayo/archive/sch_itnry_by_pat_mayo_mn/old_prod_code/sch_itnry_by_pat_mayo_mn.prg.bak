...
declare CMRN_cd = f8 with protected,   constant(uar_get_code_by("MEANING", 4, "CMRN"))     ;099
...
join MRN 																	;099
   where mrn.person_id = r.person_id										;099
   and mrn.person_alias_type_cd = cmrn_cd									;099
   and mrn.active_ind = 1													;099
   and mrn.end_effective_dt_tm > sysdate									;099
