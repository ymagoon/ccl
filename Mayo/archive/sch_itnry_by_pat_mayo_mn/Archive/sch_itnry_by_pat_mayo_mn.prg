...
;005       t_list->loc[lLocCnt].phone = "6087850940"
	...
	elseif (loc_disp_ucase IN ("FBCV OB/GYN")) ;023
		t_list->loc[lLocCnt].building = "Women's Health   Allina - District One Hospital" ;023
		t_list->loc[lLocCnt].phone = "5073333300" ;023
    endif
/*003 END*/
