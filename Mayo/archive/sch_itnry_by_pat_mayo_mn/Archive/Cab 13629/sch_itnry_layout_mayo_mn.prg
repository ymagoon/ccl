drop program sch_itnry_layout_mayo_mn go
create program sch_itnry_layout_mayo_mn
...
;    * 002 02/13/12 m063907             Renamed file and build layout with changes                              *
;~DE~************************************************************************************************************
...
;002 commented out the following, it is now in the dvl file
;;/**************************************************************
...
%i mhs_prg:sch_itnry_layout_mayo_mn.dvl
