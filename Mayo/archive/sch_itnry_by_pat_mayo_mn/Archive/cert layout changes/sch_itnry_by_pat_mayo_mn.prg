...
declare home_addr_cd = f8 with protected,   constant(uar_get_code_by("MEANING", 212, "HOME")) ;016
 
declare spec_type_cd = f8 with protected,   constant(uar_get_code_by("DISPLAYKEY", 16449, "SPECIMENTYPE")) ;016
 
declare CAN_ORDER_cd = f8 with protected, 	constant(uar_get_code_by("MEANING", 6004, "CANCELED"))
declare DEL_ORDER_cd = f8 with protected, 	constant(uar_get_code_by("MEANING", 6004, "DELETED"))
declare DISC_ORDER_cd = f8 with protected, 	constant(uar_get_code_by("MEANING", 6004, "DISCONTINUED"))
...
join o where o.order_id = sea.order_id
    AND O.order_status_cd NOT IN (CAN_ORDER_cd,DEL_ORDER_cd,DISC_ORDER_cd)  ;099
join od
