DROP PROGRAM mchs_rpt_open_preg GO
CREATE PROGRAM mchs_rpt_open_preg
prompt
...
with OUTDEV, qtype, operator, num_wks1, num_wks2, s_date, e_date, org, search_type,
...
EXECUTE mchs_RPT_OPEN_PREG_DRV "MINE",$QTYPE,$OPERATOR,$NUM_WKS1,$NUM_WKS2,$S_DATE,$E_DATE,$ORG,$SEARCH_TYPE,$PHYS_LAST_NAME,$PHYSICIAN
...
DECLARE _DIOTYPE = I2 WITH NOCONSTANT (38 ) ,PROTECT
