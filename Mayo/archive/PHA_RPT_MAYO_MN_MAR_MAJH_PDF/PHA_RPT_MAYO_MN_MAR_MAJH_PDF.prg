...
Created date:  09/20/2010
*******************************************************************/
;001 akcpel     Rebranding
  
set trace backdoor p30ins go
DROP PROGRAM   PHA_RPT_MAYO_MN_MAR_MAJH_PDF : DBA  GO
CREATE PROGRAM  PHA_RPT_MAYO_MN_MAR_MAJH_PDF : DBA
...
SET  PRINTFILE  =  CONCAT ( "mhs_ops:phamar_MAJH" ,  TRIM ( CNVTSTRING ( DATA -> RUN_ID )),  ".pdf" )
