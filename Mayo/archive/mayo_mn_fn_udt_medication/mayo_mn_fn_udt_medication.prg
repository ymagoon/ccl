...
;    114    07/01/14     Akcia-Se			for insulin make sure to show units and not ml
;****************************************************************************
...
foot o.order_id
  ...
  if(rpt_data->order_qual[d2.seq].VOLUMEDOSE != "")
    if (findstring("insulin",o.order_mnemonic) > 0)					;114
	    rpt_data->order_qual[d2.seq].detail_display = concat(		;114
	  rpt_data->order_qual[d2.seq].STRENGTHDOSE , " ",				;114
	  rpt_data->order_qual[d2.seq].STRENGTHDOSEUNIT , ", ",			;114
	  rpt_data->order_qual[d2.seq].RXROUTE, ", ",					;114
	  rpt_data->order_qual[d2.seq].FREQ, " ")						;114
    else															;114
