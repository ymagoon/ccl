...
;****************************************************************************
drop program   mayo_mn_fn_udt_medication120913 : dba  go
create program  mayo_mn_fn_udt_medication120913 : dba
...
;se  and o.orig_ord_as_flag = 1
  ...
  and o.current_start_dt_tm >= cnvtdatetime(reg_dt_tm)
...
;  call echo(rpt_data->order_qual[cnt].action)
  call echo(o.ordered_as_mnemonic)
  call echo(o.orig_ord_as_flag)
 
  else
;  call echo(format(o.orig_order_dt_tm,"mm/dd/yy hh:mm:ss;;d"))
...
;  call echo(format(cnvtdatetime(disch_recon_dt_tm),"mm/dd/yy hh:mm:ss;;d"))
      rpt_data->order_qual[cnt].order_id = o.order_id
  endif
 else
  add_new = 0
...
;      	  call echo(build(o.order_id,format(reg_dt_tm,"mm/dd/yy hh:mm:ss;;d")))
;      	  call echo(build("oc.updt",format(oc.updt_dt_tm,"mm/dd/yy hh:mm:ss;;d")))
...
first_time = "N"
;      	  call echo(build(o.order_id,format(o.orig_order_dt_tm,"mm/dd/yy hh:mm:ss;;d")))
;      	  call echo(build("oc.updt",format(oc.updt_dt_tm,"mm/dd/yy hh:mm:ss;;d")))
if (cnt = 1 and o.orig_order_dt_tm < cnvtdatetime(hold_com_date) and rpt_data->order_qual[d2.seq].action != "new" )
   if (o.orig_ord_as_flag = 2 and
...
;007  with nocounter, outerjoin = d3
 with nocounter,outerjoin=d4,dontcare= ocd, outerjoin = d3 ;007
...
set sText = build(sText,"<td width=150", sStyleCenter, ;001
								"<b>How to Take</b>", csSpanEnd, csTableDefEnd)
