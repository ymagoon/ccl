DROP PROGRAM   SCH_OPS_DOWN_FB : DBA  GO
CREATE PROGRAM  SCH_OPS_DOWN_FB : DBA
...
ELSEIF ( ( REP_FIND_GRP_ID -> QUAL_CNT >1 ) )
 CALL ECHO (
"More than one resrouce group returned!! You have duplicate mnemonics for your resource groups." )
 CALL ECHO (
