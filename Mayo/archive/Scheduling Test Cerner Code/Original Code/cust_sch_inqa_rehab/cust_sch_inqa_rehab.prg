...
%i cclsource:cust_sch_inqa_rehab_main_select.inc
...
%i cclsource:cust_sch_inqa_rehab_main_where.inc
%i cclsource:cust_sch_inqa_rehab_main_rw.inc
...
set request->qual[1].oe_field_dt_tm_value = cnvtdatetime("20-MAY-2012 00:00:00") go
