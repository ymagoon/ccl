drop program cust_sch_inqa_persononly:dba go
create program cust_sch_inqa_persononly:dba
...
/****************************************************************************
        Source file name:       cust_sch_inqa_persononly.prg
        Object name:            cust_sch_inqa_persononly
        Request #:              
        Product:                DCP
        ...
        Program purpose:        Standard Person Inquiry with scheduling security for appt types
...
set t_index = t_index + 1
set reply->attr_qual[t_index]->attr_name  = "requestor_display"
set reply->attr_qual[t_index]->attr_label = "Requesting Provider"
set reply->attr_qual[t_index]->attr_type  = "VC"
