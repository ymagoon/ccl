drop program cust_sch_inqa_orderonly:dba go
create program cust_sch_inqa_orderonly:dba
...
/****************************************************************************
        Source file name:       cust_sch_inqa_orderonly.prg
        Object name:            cust_sch_inqa_orderonly
        Request #:              
        Product:                DCP
        ...
        Program purpose:        Person with Orders - No Reschedules
