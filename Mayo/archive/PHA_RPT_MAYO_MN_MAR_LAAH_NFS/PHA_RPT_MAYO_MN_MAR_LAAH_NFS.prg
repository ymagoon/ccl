...
DROP PROGRAM   PHA_RPT_MAYO_MN_MAR_LAAH_NFS : DBA  GO
CREATE PROGRAM  PHA_RPT_MAYO_MN_MAR_LAAH_NFS : DBA
...
SET  PRINTFILE  =  CONCAT ( "mhs_ops:phamar_LAAH" ,  TRIM ( CNVTSTRING ( DATA -> RUN_ID )),  ".pdf" )
