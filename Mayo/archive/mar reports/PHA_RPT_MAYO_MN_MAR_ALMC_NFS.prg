...
DROP PROGRAM   PHA_RPT_MAYO_MN_MAR_ALMC_NFS : DBA  GO
CREATE PROGRAM  PHA_RPT_MAYO_MN_MAR_ALMC_NFS : DBA
...
SET  PRINTFILE  =  CONCAT ( "mhs_ops:phamar_ALMC" ,  TRIM ( CNVTSTRING ( DATA -> RUN_ID )),  ".pdf" )
