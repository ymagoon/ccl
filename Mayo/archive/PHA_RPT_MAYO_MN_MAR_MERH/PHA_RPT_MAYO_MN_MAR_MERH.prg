...
DROP PROGRAM   PHA_RPT_MAYO_MN_MAR_MERH : DBA  GO
CREATE PROGRAM  PHA_RPT_MAYO_MN_MAR_MERH : DBA
...
SET  PRINTFILE  =  CONCAT ( "mhs_ops:phamar_MERH" ,  TRIM ( CNVTSTRING ( DATA -> RUN_ID )),  ".pdf" )
