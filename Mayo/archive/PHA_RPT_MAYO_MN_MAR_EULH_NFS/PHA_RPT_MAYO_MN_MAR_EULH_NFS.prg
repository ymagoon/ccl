...
DROP PROGRAM   PHA_RPT_MAYO_MN_MAR_EULH_NFS: DBA  GO
CREATE PROGRAM  PHA_RPT_MAYO_MN_MAR_EULH_NFS : DBA

;001 akcpel     Rebranding
...
SET  PRINTFILE  =  CONCAT ( "mhs_ops:phamar_EULH" ,  TRIM ( CNVTSTRING ( DATA -> RUN_ID )),  ".pdf" )
