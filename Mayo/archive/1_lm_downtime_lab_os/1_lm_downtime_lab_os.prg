...
drop program 1_lm_downtime_lab_os go
create program 1_lm_downtime_lab_os
...
where pa.person_id = p.person_id
  ;and pa.person_alias_type_cd = mrn_var
   and pa.alias_pool_cd = 10579679.00	;OS MRN
  and pa.active_ind = 1
...
head page
	...
	count = count + 1
	row + 1, "{f/9}{cpi/9}"
	call print(calcpos(242,y_pos+7)) "Oakridge Hospital"
...
head p.name_full_formatted
	...
	call print(calcpos(425,y_pos+11)) "OS MRN"
...
foot page
	...
	call print(calcpos(20,y_pos+11)) "Lab Orders (Oakridge), page: "
