...
%i cclsource:status_block.inc
    ...
    IF (CURDOMAIN = "MHCRT")
		return (BUILD2(
			...
			^</h2>^,
			; 006  - changed URL!!!!!!
;			^<a href='https://mayomchc.stagingiqhealth.com/appointments/request' target='_parent'>\
			^<a href='https://iqhealth.myhealtheexchange.com/iqhealth/scheduling/mayo_mn/addAppointmentToCalendar' target='_parent'>\
	...
	ELSE ; SET THE SAME AS MHCRT FOR NOW
		return (BUILD2(
			html_head,
			^<h1 class="sec-hd">^,
				^Upcoming Appointments^,
