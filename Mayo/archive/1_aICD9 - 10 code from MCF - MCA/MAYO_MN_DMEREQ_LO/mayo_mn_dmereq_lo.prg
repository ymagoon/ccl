drop program mayo_mn_dmereq_lo:dba go
create program mayo_mn_dmereq_lo:dba
/************************************************************************
 *                                                                      *
...
%i mhs_prg:mayo_mn_dmereq_lo.dvl
;initialize variables
declare req_addr_line = vc
declare ord_detail4  = vc
declare ord_detail3  = vc
...
if (print_watermark_override = 1)
	set Print_watermark = 0
endif
