...
Modifications:		Added Family Med for MCLC (8/5/2009)
			 		Moved cameron to their own report (07/13/2009)
...
drop program 1_lm_labnoshow_other go
create program 1_lm_labnoshow_other
...
1 dept_printers_list[2]
	2 dept = C24
	2 printer_name = C6 )
set dept_printers -> dept_printers_list[1] -> dept = "Family Medicine - MCLC"
set dept_printers -> dept_printers_list[1] -> printer_name = "PH2147"
set dept_printers -> dept_printers_list[2] -> dept = "Family Medicine Planned Visit Phy - MCLC"
set dept_printers -> dept_printers_list[2] -> printer_name = "PH2147"
SET MaxSecs = 900
