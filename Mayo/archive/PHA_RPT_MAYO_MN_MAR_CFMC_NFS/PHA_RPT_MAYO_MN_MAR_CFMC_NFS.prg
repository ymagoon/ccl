...
DROP PROGRAM   PHA_RPT_MAYO_MN_MAR_CFMC_NFS : DBA  GO
CREATE PROGRAM  PHA_RPT_MAYO_MN_MAR_CFMC_NFS : DBA
...
SET  PRINTFILE  =  CONCAT ( "mhs_ops:phamar_CFMC" ,  TRIM ( CNVTSTRING ( DATA -> RUN_ID )),  ".pdf" )
