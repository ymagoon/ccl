...
DROP PROGRAM   PHA_RPT_MAYO_MN_MAR_LASF_NFS : DBA  GO
CREATE PROGRAM  PHA_RPT_MAYO_MN_MAR_LASF_NFS : DBA
...
SET  PRINTFILE  =  CONCAT ( "mhs_ops:phamar_LASF" ,  TRIM ( CNVTSTRING ( DATA -> RUN_ID )),  ".pdf" )
...
;009 AND ( O
;009WHERE (PO.ORDER_ID=O.ORDER_ID))
 AND ( OD
