...
DROP PROGRAM   PHA_RPT_MAYO_MN_MAR_AMC_NFS : DBA  GO
CREATE PROGRAM  PHA_RPT_MAYO_MN_MAR_AMC_NFS : DBA
...
SET  PRINTFILE  =  CONCAT ("mhs_ops:phamar_AMC" ,  TRIM ( CNVTSTRING ( DATA -> RUN_ID )), ".pdf" )
...
"(cont.)" ,
 ...
 ROW + 1 ,
 ROW + 1 ,
 RM_STRING = SUBSTRING ( 1 ,  6 , PO.ROOM_S),
...
ELSE   PASS_FIELD_IN =PO.ML_HR,  PARSE_ZEROES ,  DSRATE = CONCAT ( TRIM ( DSVALUE ), " " , " mL/hr"
)
ENDIF
...
ENDIF
, DSFREQ = FILLSTRING ( 16 , " " ), DSFREQ = TRIM ( SUBSTRING ( 1 ,  16 , PO.FREQUENCY_S)), DSROUTE
= TRIM ( SUBSTRING ( 1 ,  10 , PO.ROUTE_S)),
