...
;001		05/31/13	Akcia-SE 	change sig line to initial line on all except last page
...
FOOT PAGE
if (for1_cnt = TEMP -> CAT_CNT)					;001
  if (for2_cnt = TEMP->CAT_QUAL[TEMP->CAT_CNT]->ORD_CNT)							;001
    "{pos/50/735}Provider Signature: _________________________________________________ Date/Time: ______________________ "
	else															;001
 		"{pos/230/735}Provider Initials:  ____________"				;001
  endif													;001
else															;001
 "{pos/50/735}Provider Initials:  ____________"
endif															;001
