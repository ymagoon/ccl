...
and not cv.display_key in  ("MAYOMHS","RWPCC","ALEXPRESSCARE","ALEYECLINIC","ALFCTRMKTOOUTR",
							...
							"LOCATORROOMSONLYDONOTUSE","MAEXPRCAREBP","MAEXPRCARENP","MERCBEHAVHLTH")
and not cv.display_key in  ("*HOSP*") 
