...
Modified by:  Akcia-pel
Modified date: 10/11/12
Modifications:  Added task type code for Oracle 11 performance.
...
plan e
;pel where e.disch_dt_tm+0 between cnvtdatetime(cnvtdate(beg_dt),0)
where e.disch_dt_tm between cnvtdatetime(cnvtdate(beg_dt),0)
