...
DROP PROGRAM   PHA_RPT_MAYO_MN_MAR_LCMC : DBA  GO
CREATE PROGRAM  PHA_RPT_MAYO_MN_MAR_LCMC : DBA
...
SET  PRINTFILE  =  CONCAT ( "mhs_ops:phamar_LCMC" ,  TRIM ( CNVTSTRING ( DATA -> RUN_ID )),  ".pdf" )
