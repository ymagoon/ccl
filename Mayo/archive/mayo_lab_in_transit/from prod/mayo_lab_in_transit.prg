...
prompt
	...
	, "Start Date" = CURDATE
	, "End Date" = CURDATE
	, "Batch Number" = 0                     ;* Optional Batch Number
 
with OUTDEV, fac_grp, fac_cd, fr_lab, to_lab_facility_group, to_lab, fin_class,
	enc_type, sdate, edate, batch_nbr
