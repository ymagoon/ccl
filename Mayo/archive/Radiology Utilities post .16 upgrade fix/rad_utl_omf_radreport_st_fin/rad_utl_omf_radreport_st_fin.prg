drop program rad_utl_omf_radreport_st_fin go
create program rad_utl_omf_radreport_st_fin
...
r.final_dt_tm between cnvtdatetime("07-FEB-2013 00:00:00") and cnvtdatetime("28-FEB-2013 23:59:59") and   
...
;rad_utl_omf_radreport_st_fin.txt
;Begin logging records to be deleted JTW
;Header rows
                select into "/cerner/ops_share/mhcrt/rad_utl_omf_radreport_st_fin_DEL_LOG.dat"
                        "TranscriptionistID",
                        "ResidentID",
                        "RadiologistID",
                        "ProxyID",
