 ...
 *001 11/21/11 Rob Banks            Modify to use DB2                  *
 *zzz 02/28/13 Akcia                Change mod 001 to lookup password in registry
 ******************** End of Modification Log **************************/
DROP PROGRAM 1_mhs_lcmc_tdm GO
CREATE PROGRAM 1_mhs_lcmc_tdm
...
WHERE O.ENCNTR_ID = E.ENCNTR_ID
  AND E.loc_facility_cd = 24988876  ;in (24988875,24988876,24988877,24988878,24988879,24988880)
    AND E.loc_nurse_unit_cd  in (24991974,24991979,24992002,24992005,25049490,31158534)
