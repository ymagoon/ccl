drop program 1_mhs_inbox_documents_eu_ops:dba go
create program 1_mhs_inbox_documents_eu_ops:dba
...
SET output_file = CONCAT ("documents_to_sign_hosp", FORMAT ( CURDATE , "MMDDYY;;q" ), "_" ,FORMAT ( CURTIME , "HHMM;1;m" ), ".csv")
SET message_file = "documentstosignhosp.msg"
...
where e.disch_dt_tm+0 >= cnvtdatetime("10-AUG-2009")
...
Set dclcom1 = concat( 'echo "Attached is the Documents to Sign_Dictate Report (Hospital). \n\n',
						' " > ',
	message_file, ' && ', 'uuencode ', output_file, ' ',
	output_file, ' >> ',
	message_file, ' && ', 'cat ',
	message_file, ' | mailx -s "Documents to Sign_Dictate (Hospital)" ', $outdev )
