  drop program mayo_sch_rpt_ptletter2:dba go
create program mayo_sch_rpt_ptletter2:dba
/************************************************************************
 ...
 *004 02/28/13 Akcia                Change mod 001 to lookup password in registry
...
head lt.long_text_id  ; there may be multiple orders per appt, that have the same prep instructions
...
Execute reportrtl
%i mhs_prg:mayo_sch_rpt_ptletter2.dvl
