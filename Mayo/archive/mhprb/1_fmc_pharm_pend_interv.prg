 ...
 *--- -------- -------------------- -----------------------------------*
 *000 00/00/00 See above            Unknown                            *
 *001 11/30/11 Rob Banks            Modify to use DB2                  *
 *002 02/28/13 Akcia                Change mod 001 to lookup password in registry
 ******************** End of Modification Log **************************/
drop program 1_fmc_pharm_pend_interv:dba go
create program 1_fmc_pharm_pend_interv:dba
...
c.verified_dt_tm,
 ...
 call cclrtf_print ( 0 ,  180 ,  90 ,  75 , cel.event_tag,  255 ,  1 ),
