 ...
 *002 10/10/12 akcia- SE			changes for Oracle 11 upgrade to CBO
 *003 02/28/13 Akcia                Change mod 001 to lookup password in registry
 ******************** End of Modification Log **************************/
drop program 1_mhs_lab_order_dispatch:dba go
create program 1_mhs_lab_order_dispatch:dba
...
plan o
where o.updt_dt_tm >= cnvtdatetime(curdate-213,curtime3) and o.updt_dt_tm <= cnvtdatetime(curdate-210,curtime3)
