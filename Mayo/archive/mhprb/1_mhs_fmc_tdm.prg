...
DROP PROGRAM 1_mhs_fmc_tdm GO
CREATE PROGRAM 1_mhs_fmc_tdm
...
WHERE O.ENCNTR_ID = E.ENCNTR_ID
  AND E.loc_facility_cd = 24988850  ;(FA Fairmont Medical Center - Hospital)
    AND E.loc_nurse_unit_cd  in (24992690, 24992707, 24992726, 24992606, 24992613, 117872572, 117873327, 117873631)
