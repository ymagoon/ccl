...
DROP PROGRAM 1_mhs_rcmc_tdm GO
CREATE PROGRAM 1_mhs_rcmc_tdm
...
WHERE O.ENCNTR_ID = E.ENCNTR_ID
  AND E.loc_facility_cd = 24988897
 
  AND E.loc_nurse_unit_cd  in (24991843,24991856,24991881,24991894,24991913,24991925)
...
Foot Report
	...
	ROW + 1, "{F/5}{CPI/11}"
	CALL PRINT(CALCPOS(130,y_pos+0)) "End TDM / WARF / Amikacin / Gentamicin / Tobramycin / Vancomycin / Dabigatran Report"
