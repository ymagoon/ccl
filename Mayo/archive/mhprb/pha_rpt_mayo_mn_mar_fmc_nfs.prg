...
DROP PROGRAM   PHA_RPT_MAYO_MN_MAR_FMC_NFS : DBA  GO
CREATE PROGRAM  PHA_RPT_MAYO_MN_MAR_FMC_NFS : DBA
...
SET  PRINTFILE  =  CONCAT ("mhs_ops:phamar_FMC" ,  TRIM ( CNVTSTRING ( DATA -> RUN_ID )), ".pdf" )
