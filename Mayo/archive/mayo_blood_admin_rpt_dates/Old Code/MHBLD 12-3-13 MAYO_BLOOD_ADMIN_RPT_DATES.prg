...
declare addnl_blood_cells_cd  = f8 with public, constant(uar_get_code_by("DISPLAY_KEY",200, "TRANSFUSEADDITIONALREDBLOODCELLR"))	;10 JTW
...
;03	and ce2.EVENT_TITLE_TEXT in ("Initiation", "Transfusion V2")
	...
	Join ce3
;11	where ce3.order_id = o.order_id  ;03  ce3.parent_event_id = ce2.event_id  011 JTW
	where (ce3.order_id = o.order_id or ce3.order_id = o.template_order_id)  ; 011 JTW
