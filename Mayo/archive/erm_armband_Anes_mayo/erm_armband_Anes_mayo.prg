...
;declare checkDigitFormatted = vc		;016
declare checkDigitFormatted = c11		;016																;015
...
if (substring(1,2,cmrn_cnvt) != "AC")		;015
  ...
  ;set checkDigitsLen = textlen(cmrn_cnvt) 	;015
  set checkDigitsLen = textlen(trim(cmrn_cnvt)) ;016
  ;set cmrn_cnvt_fmted = GenerateCheckDigit(cmrn_cnvt) ;015
  set cmrn_cnvt_fmted = GenerateCheckDigit(trim(cmrn_cnvt)) ;016
 
  set barcode_mrn  = build("*",cmrn_cnvt_fmted,"*") ;015
