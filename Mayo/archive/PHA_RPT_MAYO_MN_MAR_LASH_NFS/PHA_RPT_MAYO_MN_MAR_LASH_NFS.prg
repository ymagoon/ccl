...
DROP PROGRAM   PHA_RPT_MAYO_MN_MAR_LASH_NFS : DBA  GO
CREATE PROGRAM  PHA_RPT_MAYO_MN_MAR_LASH_NFS : DBA
...
SET  PRINTFILE  =  CONCAT ( "mhs_ops:phamar_LASH" ,  TRIM ( CNVTSTRING ( DATA -> RUN_ID )),  ".pdf" )
