...
*************************************************************************/
set stat = alterlist(at_risk_plans->health_plans, 23)
...
set at_risk_plans->health_plans[23]->plan_name = "*BPP BayCare Plus"
set at_risk_plans->health_plans[23]->plan_identifiers[1]->type = "EDI"
set at_risk_plans->health_plans[23]->plan_identifiers[1]->value = "10024"
