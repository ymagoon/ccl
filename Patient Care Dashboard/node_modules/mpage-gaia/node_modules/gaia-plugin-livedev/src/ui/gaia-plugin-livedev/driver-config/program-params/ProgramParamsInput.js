        ...
        return [
            {
                typeSelect: new ButtonGroup({
                    ...
                    items: [
                        ...
                        { id: "criterion", display: "Criterion JSON (Unified Driver)" },
                        { id: "unified_org_driver", display: "Unified Org Driver" },
                        { id: "criterion_org", display: "Criterion JSON (Unified Org Driver)" },
                    ],
                })
            }
        ];
